...
#ifndef GTULU_PROGRAM_FORMATPRINT_IMAGE_HPP_
#define GTULU_PROGRAM_FORMATPRINT_IMAGE_HPP_
  ...
  namespace internal {
    ...
    namespace format {
      namespace program {
        ...
        class print_image_program_format : public fprg::static_program_format {
          protected:
            // #template#<define_shader/>

            class print_image_fragment_shader_shader_format : public fshd::static_shader_format< fshd::type::gl_fragment_shader > {
              protected:
                static char const* source;

              public:
                print_image_fragment_shader_shader_format() :
                ...
                char const* get_source() const {
                  return print_image_fragment_shader_shader_format::source;
                }

            };

            typedef obj::shader< print_image_fragment_shader_shader_format > print_image_fragment_shader_shader_t;

            

            class print_image_vertex_shader_shader_format : public fshd::static_shader_format< fshd::type::gl_vertex_shader > {
              protected:
                static char const* source;

              public:
                print_image_vertex_shader_shader_format() :
                ...
                char const* get_source() const {
                  return print_image_vertex_shader_shader_format::source;
                }

            };

            typedef obj::shader< print_image_vertex_shader_shader_format > print_image_vertex_shader_shader_t;

            

          public:
            print_image_program_format() {
              // #template#<declare_shader/>

              print_image_fragment_shader_shader_t print_image_fragment_shader_shader;

              attach(print_image_fragment_shader_shader);

              

              print_image_vertex_shader_shader_t print_image_vertex_shader_shader;

              attach(print_image_vertex_shader_shader);
            ...
            void set_background(obj::texture< TextureFormat > const& value) {
              obj::program_base::bind();
              background_binder_t::bind(0, value);
            }
            ...
            struct framebuffer_format : public obj::framebuffer_base, public fbf::framebuffer_format_base< DrawableType > {
              ...
              void set_output_image(NewDrawableType const& drawable) {
            ...
            struct vertex_array_format : public obj::vertexarray_base, public drw::drawable {
              ...
              inline void draw(obj::program< print_image_program_format > const& program,
              ...
              template< typename DrawingMode = drw::mode::gl_triangles >
              inline void draw_multiple(obj::program< print_image_program_format > const& program,
              ...
              template< typename DrawingMode = drw::mode::gl_triangles, typename BufferFormat >
              inline void draw_range(obj::program< print_image_program_format > const& program,
                                     obj::buffer< BufferFormat > const&                 buffer,
                                     std::uint32_t const                                count,
              ...
              void set_texture_position(BOOST_PP_ENUM_PARAMS(2, DataFormat const texture_position)) {
                obj::vertexarray_base::bind();
                texture_position_binder_t::bind(1, BOOST_PP_ENUM_PARAMS(2, texture_position));
              }

              template< typename BufferFormat >
              void set_texture_position(obj::buffer< BufferFormat > const& buffer,
                                 std::uint32_t const                offset=0,
                                 std::uint32_t const                stride=0) {
                obj::vertexarray_base::bind();
                texture_position_buffer_binder_t::bind(1, buffer, offset, stride);
              }

              template< typename BufferFormat >
              void set_texture_position_normalized(obj::buffer< BufferFormat > const& buffer,
                                            std::uint32_t const                offset=0,
                                            std::uint32_t const                stride=0) {
                obj::vertexarray_base::bind();
                texture_position_buffer_binder_t::bind< fcmn::normalization::normalized
                                                 >(1, buffer, offset, stride);
              }

              template< typename BufferFormat >
              void set_texture_position_gbra(obj::buffer< BufferFormat > const& buffer,
                                      std::uint32_t const                offset=0,
                                      std::uint32_t const                stride=0) {
                obj::vertexarray_base::bind();
                texture_position_buffer_binder_t::bind< fcmn::normalization::none, fcmn::order::reverse
                                                 >(1, buffer, offset, stride);
              }
...
#endif /* GTULU_PROGRAM_FORMATPRINT_IMAGE_HPP_ */
