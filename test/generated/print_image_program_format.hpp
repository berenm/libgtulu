      ...
      namespace program {
        ...
        class print_image_program_format: public fprg::static_program_format {
          protected:
            ...
            class print_image_fragment_shader_shader_format: public fshd::static_shader_format<
                fshd::type::gl_fragment_shader > {
              protected:
            ...
            class print_image_vertex_shader_shader_format: public fshd::static_shader_format<
                fshd::type::gl_vertex_shader > {
              protected:
                static char const* source;
