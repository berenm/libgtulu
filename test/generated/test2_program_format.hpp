        ...
        class test2_program_format : public fprg::static_program_format {
          ...
          public:
            ...
            struct vertex_array_format : public obj::vertexarray_base, public drw::drawable {
              ...
              inline void draw(obj::program< test2_program_format > const& program,
              ...
              template< typename DrawingMode = drw::mode::gl_triangles >
              inline void draw_multiple(obj::program< test2_program_format > const& program,
              ...
              template< typename DrawingMode = drw::mode::gl_triangles, typename BufferFormat >
              inline void draw_range(obj::program< test2_program_format > const& program,
                                     obj::buffer< BufferFormat > const&                 buffer,
                                     std::uint32_t const                                count,
