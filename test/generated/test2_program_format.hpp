  ...
  namespace internal {
    ...
    namespace formats {
      namespace program {
        ...
        class test2_program_format: public fp::static_program_format {
          protected:
            // #template#<define_shader/>

            class test2_fragment_shader_shader_format: public fs::static_shader_format< fst::gl_fragment_shader > {
              protected:
