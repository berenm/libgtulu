...
#ifndef GTULU_PROGRAM_FORMATPLOT_IMAGE_HPP_
#define GTULU_PROGRAM_FORMATPLOT_IMAGE_HPP_
  ...
  namespace internal {
    ...
    namespace format {
      namespace program {
        ...
        class plot_image_program_format : public fprg::static_program_format {
          protected:
            // #template#<define_shader/>

            class plot_image_fragment_shader_shader_format : public fshd::static_shader_format< fshd::type::gl_fragment_shader > {
              protected:
                static char const* source;

              public:
                plot_image_fragment_shader_shader_format() :
                ...
                char const* get_source() const {
                  return plot_image_fragment_shader_shader_format::source;
                }

            };

            typedef obj::shader< plot_image_fragment_shader_shader_format > plot_image_fragment_shader_shader_t;

            

            class plot_image_vertex_shader_shader_format : public fshd::static_shader_format< fshd::type::gl_vertex_shader > {
              protected:
                static char const* source;

              public:
                plot_image_vertex_shader_shader_format() :
                ...
                char const* get_source() const {
                  return plot_image_vertex_shader_shader_format::source;
                }

            };

            typedef obj::shader< plot_image_vertex_shader_shader_format > plot_image_vertex_shader_shader_t;

            

          public:
            plot_image_program_format() {
              // #template#<declare_shader/>

              plot_image_fragment_shader_shader_t plot_image_fragment_shader_shader;

              attach(plot_image_fragment_shader_shader);

              

              plot_image_vertex_shader_shader_t plot_image_vertex_shader_shader;

              attach(plot_image_vertex_shader_shader);
            ...
            struct vertex_array_format : public obj::vertexarray_base, public drw::drawable {
              ...
              inline void draw(obj::program< plot_image_program_format > const& program,
              ...
              template< typename DrawingMode = drw::mode::gl_triangles >
              inline void draw_multiple(obj::program< plot_image_program_format > const& program,
              ...
              template< typename DrawingMode = drw::mode::gl_triangles, typename BufferFormat >
              inline void draw_range(obj::program< plot_image_program_format > const& program,
                                     obj::buffer< BufferFormat > const&                 buffer,
                                     std::uint32_t const                                count,
...
#endif /* GTULU_PROGRAM_FORMATPLOT_IMAGE_HPP_ */
