        ...
        class plot_image_program_format: public fprg::static_program_format {
          ...
          public:
            ...
            struct vertex_array_format: public obj::vertexarray_base, public drw::drawable {
                ...
                inline void draw(obj::program< plot_image_program_format > const& program_in,
                ...
                template< typename DrawingMode = drw::mode::gl_triangles >
                inline void draw_multiple(obj::program< plot_image_program_format > const& program_in,
                ...
                template< typename DrawingMode = drw::mode::gl_triangles, typename BufferFormat >
                inline void draw_range(obj::program< plot_image_program_format > const& program_in,
                                       obj::buffer< BufferFormat > const& buffer_in,
                                       std::uint32_t const count_in,
