  ...
  namespace internal {
    ...
    namespace context {
      ...
      struct gettor {
          ...
          template< typename parameter_t >
          static void get(::boost::uint32_t index, return_type_t* data);
      };
...
#define DECLARE_GETTOR_INDEXED(return_type_m, function_m, indexed_function_m) \
      ...
      DECLARE_GETTOR_INDEXED(::boost::uint8_t, gl_get_booleanv, gl_get_booleani_v)
      DECLARE_GETTOR_INDEXED(::boost::int32_t, gl_get_integerv, gl_get_integeri_v)
      DECLARE_GETTOR_INDEXED(::boost::int64_t, gl_get_integer_64_v, gl_get_integer_64_i_v)
...
#define DECLARE_GETTOR_DYNAMIC(parameter_m, size_parameter_m, return_type_m) \
      ...
      DECLARE_GETTOR_TYPED(gl_active_texture, 1, ::boost::uint32_t)
      ...
      DECLARE_GETTOR_TYPED(gl_array_buffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_blend, 1, ::boost::uint8_t)
      //      DECLARE_GETTOR(gl_blend_color, 4)
      DECLARE_GETTOR_TYPED(gl_blend_dst_alpha, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_blend_dst_rgb, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_blend_equation_alpha, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_blend_equation_rgb, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_blend_src_alpha, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_blend_src_rgb, 1, ::boost::int32_t)
      DECLARE_GETTOR(gl_color_clear_value, 4)
      DECLARE_GETTOR_TYPED(gl_color_logic_op, 1, ::boost::uint8_t)
      DECLARE_GETTOR_TYPED(gl_color_writemask, 4, ::boost::uint8_t)

      DECLARE_GETTOR_TYPED(gl_num_compressed_texture_formats, 1, ::boost::int32_t)

      DECLARE_GETTOR_DYNAMIC(gl_compressed_texture_formats, gl_num_compressed_texture_formats, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_cull_face, 1, ::boost::uint8_t)
      DECLARE_GETTOR_TYPED(gl_current_program, 1, ::boost::int32_t)
      DECLARE_GETTOR(gl_depth_clear_value, 1)
      DECLARE_GETTOR_TYPED(gl_depth_func, 1, ::boost::int32_t)
      DECLARE_GETTOR(gl_depth_range, 2)
      DECLARE_GETTOR_TYPED(gl_depth_test, 1, ::boost::uint8_t)
      DECLARE_GETTOR_TYPED(gl_depth_writemask, 1, ::boost::uint8_t)
      DECLARE_GETTOR_TYPED(gl_dither, 1, ::boost::uint8_t)
      DECLARE_GETTOR_TYPED(gl_doublebuffer, 1, ::boost::uint8_t)
      DECLARE_GETTOR_TYPED(gl_draw_buffer, 1, ::boost::int32_t)
      //      DECLARE_GETTOR_TYPED(gl_draw_buffer_i, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_draw_framebuffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_read_framebuffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_element_array_buffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_renderbuffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_fragment_shader_derivative_hint, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_line_smooth, 1, ::boost::uint8_t)
      DECLARE_GETTOR_TYPED(gl_line_smooth_hint, 1, ::boost::int32_t)
      ...
      DECLARE_GETTOR_TYPED(gl_logic_op_mode, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_3d_texture_size, 1, ::boost::int32_t)
      DECLARE_GETTOR(gl_max_clip_distances, 1)
      DECLARE_GETTOR_TYPED(gl_max_combined_fragment_uniform_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_combined_texture_image_units, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_combined_vertex_uniform_components, 1, ::boost::int32_t)
      //      DECLARE_GETTOR_TYPED(gl_max_combined_geometry_uniform_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_varying_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_combined_uniform_blocks, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_cube_map_texture_size, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_draw_buffers, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_dual_source_draw_buffers, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_elements_indices, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_elements_vertices, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_fragment_uniform_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_fragment_uniform_blocks, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_fragment_input_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_min_program_texel_offset, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_program_texel_offset, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_rectangle_texture_size, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_texture_image_units, 1, ::boost::int32_t)
      DECLARE_GETTOR(gl_max_texture_lod_bias, 1)
      DECLARE_GETTOR_TYPED(gl_max_texture_size, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_renderbuffer_size, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_array_texture_layers, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_texture_buffer_size, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_uniform_block_size, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_varying_floats, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_vertex_attribs, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_vertex_texture_image_units, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_geometry_texture_image_units, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_vertex_uniform_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_vertex_output_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_geometry_uniform_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_sample_mask_words, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_color_texture_samples, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_depth_texture_samples, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_integer_samples, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_server_wait_timeout, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_uniform_buffer_bindings, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_uniform_buffer_offset_alignment, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_vertex_uniform_blocks, 1, ::boost::int32_t)
      //      DECLARE_GETTOR_TYPED(gl_max_geometry_uniform_blocks, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_geometry_input_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_geometry_output_components, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_max_viewport_dims, 2, ::boost::int32_t)

      DECLARE_GETTOR_TYPED(gl_pack_alignment, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_pack_image_height, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_pack_lsb_first, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_pack_row_length, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_pack_skip_images, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_pack_skip_pixels, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_pack_skip_rows, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_pack_swap_bytes, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_pixel_pack_buffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_pixel_unpack_buffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR(gl_point_fade_threshold_size, 1)
      DECLARE_GETTOR_TYPED(gl_provoking_vertex, 1, ::boost::int32_t)
      ...
      DECLARE_GETTOR_TYPED(gl_polygon_offset_fill, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_polygon_offset_line, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_polygon_offset_point, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_polygon_smooth, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_polygon_smooth_hint, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_read_buffer, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_sample_buffers, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_sample_coverage_value, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_sample_coverage_invert, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_sampler_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_samples, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_scissor_box, 4, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_scissor_test, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_stencil_back_fail, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_back_func, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_back_pass_depth_fail, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_back_pass_depth_pass, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_back_ref, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_back_value_mask, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_back_writemask, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_clear_value, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_fail, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_func, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_pass_depth_fail, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_pass_depth_pass, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_ref, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_test, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_stencil_value_mask, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stencil_writemask, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_stereo, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_subpixel_bits, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_1d, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_1d_array, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_2d, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_2d_array, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_2d_multisample, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_2d_multisample_array, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_3d, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_buffer, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_cube_map, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_binding_rectangle, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_compression_hint, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_texture_buffer_data_store_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_timestamp, 1, ::boost::int64_t)
      DECLARE_GETTOR_INDEXED(gl_transform_feedback_buffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_INDEXED(gl_transform_feedback_buffer_start, 1, ::boost::int64_t)
      DECLARE_GETTOR_INDEXED(gl_transform_feedback_buffer_size, 1, ::boost::int64_t)
      DECLARE_GETTOR_INDEXED(gl_uniform_buffer_binding, 1, ::boost::int32_t)
      DECLARE_GETTOR_INDEXED(gl_uniform_buffer_start, 1, ::boost::int64_t)
      DECLARE_GETTOR_INDEXED(gl_uniform_buffer_size, 1, ::boost::int64_t)
      DECLARE_GETTOR_TYPED(gl_unpack_alignment, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_unpack_image_height, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_unpack_lsb_first, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_unpack_row_length, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_unpack_skip_images, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_unpack_skip_pixels, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_unpack_skip_rows, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_unpack_swap_bytes, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_num_extensions, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_major_version, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_minor_version, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_context_flags, 1, ::boost::int32_t)
      DECLARE_GETTOR_TYPED(gl_vertex_program_point_size, 1, ::boost::int8_t)
      DECLARE_GETTOR_TYPED(gl_viewport, 4, ::boost::int32_t)

      DECLARE_GETTOR_TYPED(gl_max_color_attachments, 1, ::boost::int32_t)
