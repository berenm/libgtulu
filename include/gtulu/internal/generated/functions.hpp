          ...
          namespace function {
            ...
            struct gl_blend_func< C1, C2 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glBlendFunc " "sfactor: '" << SfactorConstant::name()
                      << "'" ", " "dfactor: '" << DfactorConstant::name() << "'";
                ...
                inline static void call(std::uint32_t buf) {
                  ...
                  __gtulu_debug() << "call glBlendFunci " "buf: '" << buf << "'" ", " "src: '" << SrcConstant::name()
                      << "'" ", " "dst: '" << DstConstant::name() << "'";
            ...
            struct gl_blend_func< > {
                ...
                inline static void call(std::uint32_t buf,
                                        cst::gl_constant_base const& src,
                                        cst::gl_constant_base const& dst) {
                  __gtulu_debug() << "call glBlendFunci " "buf: '" << buf << "'" ", " "src: '" << src
                      << "'" ", " "dst: '" << dst << "'";
            ...
            struct gl_clear_color< > {
                inline static void call(float red, float green, float blue, float alpha) {
                  __gtulu_debug() << "call glClearColor " "red: '" << red << "'" ", " "green: '" << green
            ...
            struct gl_color_mask< > {
                inline static void call(bool red, bool green, bool blue, bool alpha) {
                  __gtulu_debug() << "call glColorMask " "red: '" << red << "'" ", " "green: '" << green
                      << "'" ", " "blue: '" << blue << "'" ", " "alpha: '" << alpha << "'";
                ...
                inline static void call(std::uint32_t index, bool r, bool g, bool b, bool a) {
                  __gtulu_debug() << "call glColorMaski " "index: '" << index << "'" ", " "r: '" << r << "'" ", " "g: '"
                      << g << "'" ", " "b: '" << b << "'" ", " "a: '" << a << "'";
            ...
            struct gl_disable< C1 > {
                ...
                inline static void call(std::uint32_t index) {
                  ...
                  __gtulu_debug() << "call glDisablei " "target: '" << TargetConstant::name() << "'" ", " "index: '"
                      << index << "'";
            ...
            struct gl_enable< C1 > {
                ...
                inline static void call(std::uint32_t index) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glEnablei " "target: '" << TargetConstant::name() << "'" ", " "index: '"
                      << index << "'";
            ...
            struct gl_get_boolean< C1 > {
                inline static void call(GLboolean* params) {
                  ...
                  __gtulu_debug() << "call glGetBooleanv " "pname: '" << PnameConstant::name() << "'" ", " "params: '"
                      << params << "'";
            ...
            struct gl_get_double< C1 > {
                inline static void call(double* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetDoublev " "pname: '" << PnameConstant::name() << "'" ", " "params: '"
                      << params << "'";
            ...
            struct gl_get_float< C1 > {
                inline static void call(float* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetFloatv " "pname: '" << PnameConstant::name() << "'" ", " "params: '"
                      << params << "'";
            ...
            struct gl_get_integer< C1 > {
                inline static void call(std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetIntegerv " "pname: '" << PnameConstant::name() << "'" ", " "params: '"
                      << params << "'";
                ...
                inline static void call(GLint64* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetInteger64v " "pname: '" << PnameConstant::name() << "'" ", " "params: '"
                      << params << "'";
            ...
            struct gl_get_string< C1 > {
                ...
                inline static GLubyte const* call(std::uint32_t index) {
                  typedef C1 NameConstant;
                  __gtulu_debug() << "call glGetStringi " "name: '" << NameConstant::name() << "'" ", " "index: '"
                      << index << "'";
            ...
            struct gl_get_tex_image< C1, C2, C3 > {
                inline static void call(std::int32_t level, void* pixels) {
                  ...
                  __gtulu_debug() << "call glGetTexImage " "target: '" << TargetConstant::name() << "'" ", " "level: '"
                      << level << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "pixels: '" << pixels << "'";
            ...
            struct gl_get_tex_image< > {
                inline static void call(cst::gl_constant_base const& target,
                                        std::int32_t level,
                                        cst::gl_constant_base const& format,
                                        cst::gl_constant_base const& type,
                                        void* pixels) {
                  __gtulu_debug() << "call glGetTexImage " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "format: '" << format << "'" ", " "type: '" << type << "'" ", " "pixels: '" << pixels
                      << "'";
            ...
            struct gl_get_tex_level_parameter< C1, C2 > {
                inline static void call(std::int32_t level, float* params) {
                  ...
                  __gtulu_debug() << "call glGetTexLevelParameterfv " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "pname: '" << PnameConstant::name()
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::int32_t level, std::int32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetTexLevelParameteriv " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "pname: '" << PnameConstant::name()
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_tex_level_parameter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        std::int32_t level,
                                        cst::gl_constant_base const& pname,
                                        float* params) {
                  __gtulu_debug() << "call glGetTexLevelParameterfv " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "pname: '" << pname << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetTexLevelParameteriv " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "pname: '" << pname << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_tex_parameter< C1, C2 > {
                inline static void call(float* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetTexParameterfv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::int32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetTexParameteriv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_tex_parameter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        float* params) {
                  __gtulu_debug() << "call glGetTexParameterfv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetTexParameteriv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_hint< C1, C2 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glHint " "target: '" << TargetConstant::name() << "'" ", " "mode: '"
                      << ModeConstant::name() << "'";
            ...
            struct gl_is_enabled< C1 > {
                ...
                inline static GLboolean call(std::uint32_t index) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glIsEnabledi " "target: '" << TargetConstant::name() << "'" ", " "index: '"
                      << index << "'";
            ...
            struct gl_pixel_store< C1 > {
                inline static void call(float param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPixelStoref " "pname: '" << PnameConstant::name() << "'" ", " "param: '"
                      << param << "'";
                ...
                inline static void call(std::int32_t param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPixelStorei " "pname: '" << PnameConstant::name() << "'" ", " "param: '"
                      << param << "'";
            ...
            struct gl_polygon_mode< C1, C2 > {
                inline static void call() {
                  ...
                  typedef C2 ModeConstant;
                  __gtulu_debug() << "call glPolygonMode " "face: '" << FaceConstant::name() << "'" ", " "mode: '"
                      << ModeConstant::name() << "'";
            ...
            struct gl_read_pixels< C1, C2 > {
                inline static void call(std::int32_t x, std::int32_t y, GLsizei width, GLsizei height, void* pixels) {
                  ...
                  __gtulu_debug() << "call glReadPixels " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'" ", " "format: '" << FormatConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "pixels: '" << pixels << "'";
            ...
            struct gl_read_pixels< > {
                inline static void call(std::int32_t x,
                                        std::int32_t y,
                                        GLsizei width,
                                        GLsizei height,
                                        cst::gl_constant_base const& format,
                                        ...
                                        void* pixels) {
                  __gtulu_debug() << "call glReadPixels " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'" ", " "format: '" << format << "'" ", " "type: '"
                      << type << "'" ", " "pixels: '" << pixels << "'";
            ...
            struct gl_scissor< > {
                inline static void call(std::int32_t x, std::int32_t y, GLsizei width, GLsizei height) {
                  __gtulu_debug() << "call glScissor " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'";
            ...
            struct gl_stencil_func< C1 > {
                inline static void call(std::int32_t ref, std::uint32_t mask) {
                  typedef C1 FuncConstant;
                  __gtulu_debug() << "call glStencilFunc " "func: '" << FuncConstant::name() << "'" ", " "ref: '" << ref
                      << "'" ", " "mask: '" << mask << "'";
            ...
            struct gl_stencil_func< > {
                inline static void call(cst::gl_constant_base const& func, std::int32_t ref, std::uint32_t mask) {
                  __gtulu_debug() << "call glStencilFunc " "func: '" << func << "'" ", " "ref: '" << ref
                      << "'" ", " "mask: '" << mask << "'";
            ...
            struct gl_stencil_op< C1, C2, C3 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glStencilOp " "fail: '" << FailConstant::name() << "'" ", " "zfail: '"
                      << ZfailConstant::name() << "'" ", " "zpass: '" << ZpassConstant::name() << "'";
            ...
            struct gl_stencil_op< > {
                inline static void call(cst::gl_constant_base const& fail,
                                        cst::gl_constant_base const& zfail,
                                        cst::gl_constant_base const& zpass) {
                  __gtulu_debug() << "call glStencilOp " "fail: '" << fail << "'" ", " "zfail: '" << zfail
                      << "'" ", " "zpass: '" << zpass << "'";
            ...
            struct gl_tex_image_1d< C1, C2, C3, C4 > {
                inline static void call(std::int32_t level, GLsizei width, std::int32_t border, void const* pixels) {
                  ...
                  __gtulu_debug() << "call glTexImage1D " "target: '" << TargetConstant::name() << "'" ", " "level: '"
                      << level << "'" ", " "internalformat: '" << InternalformatConstant::name() << "'" ", " "width: '"
                      << width << "'" ", " "border: '" << border << "'" ", " "format: '" << FormatConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "pixels: '" << pixels << "'";
                  glTexImage1D(TargetConstant::value,
                               level,
                               InternalformatConstant::value,
                               width,
                               border,
            ...
            struct gl_tex_image_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* pixels) {
                  __gtulu_debug() << "call glTexImage1D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "border: '" << border << "'" ", " "format: '" << format << "'" ", " "type: '" << type
                      << "'" ", " "pixels: '" << pixels << "'";
                  glTexImage1D(std::uint32_t(target),
                               level,
            ...
            struct gl_tex_image_2d< C1, C2, C3, C4 > {
                inline static void call(std::int32_t level,
                                        GLsizei width,
                                        GLsizei height,
                                        std::int32_t border,
                                        void const* pixels) {
                  ...
                  typedef C3 FormatConstant;
                  typedef C4 TypeConstant;
                  __gtulu_debug() << "call glTexImage2D " "target: '" << TargetConstant::name() << "'" ", " "level: '"
                      << level << "'" ", " "internalformat: '" << InternalformatConstant::name() << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'" ", " "border: '" << border
                      << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "pixels: '" << pixels << "'";
                  glTexImage2D(TargetConstant::value,
                               level,
                               InternalformatConstant::value,
                               width,
                               height,
            ...
            struct gl_tex_image_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* pixels) {
                  __gtulu_debug() << "call glTexImage2D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "border: '" << border << "'" ", " "format: '"
                      << format << "'" ", " "type: '" << type << "'" ", " "pixels: '" << pixels << "'";
                  glTexImage2D(std::uint32_t(target),
                               level,
                               std::uint32_t(internalformat),
                               width,
                               height,
            ...
            struct gl_tex_parameter< C1, C2 > {
                inline static void call(float param) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glTexParameterf " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(float const* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glTexParameterfv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::int32_t param) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glTexParameteri " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(std::int32_t const* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glTexParameteriv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_tex_parameter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        float param) {
                  __gtulu_debug() << "call glTexParameterf " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        float const* params) {
                  __gtulu_debug() << "call glTexParameterfv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t param) {
                  __gtulu_debug() << "call glTexParameteri " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t const* params) {
                  __gtulu_debug() << "call glTexParameteriv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_viewport< > {
                inline static void call(std::int32_t x, std::int32_t y, GLsizei width, GLsizei height) {
                  __gtulu_debug() << "call glViewport " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'";
          ...
          namespace function {
            ...
            struct gl_bind_texture< C1 > {
                inline static void call(std::uint32_t texture) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBindTexture " "target: '" << TargetConstant::name()
                      << "'" ", " "texture: '" << texture << "'";
            ...
            struct gl_copy_tex_image_1d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glCopyTexImage1D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "internalformat: '" << InternalformatConstant::name()
                      << "'" ", " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '" << width
                      << "'" ", " "border: '" << border << "'";
            ...
            struct gl_copy_tex_image_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        std::int32_t level,
                                        cst::gl_constant_base const& internalformat,
                                        std::int32_t x,
                                        std::int32_t y,
                                        GLsizei width,
                                        std::int32_t border) {
                  __gtulu_debug() << "call glCopyTexImage1D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "x: '" << x << "'" ", " "y: '" << y
            ...
            struct gl_copy_tex_image_2d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glCopyTexImage2D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "internalformat: '" << InternalformatConstant::name()
                      << "'" ", " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "border: '" << border << "'";
                  glCopyTexImage2D(TargetConstant::value,
                                   level,
                                   InternalformatConstant::value,
                                   x,
                                   y,
            ...
            struct gl_copy_tex_image_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei height,
                                        std::int32_t border) {
                  __gtulu_debug() << "call glCopyTexImage2D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "x: '" << x << "'" ", " "y: '" << y
                      << "'" ", " "width: '" << width << "'" ", " "height: '" << height << "'" ", " "border: '"
                      << border << "'";
                  glCopyTexImage2D(std::uint32_t(target),
                                   level,
                                   std::uint32_t(internalformat),
                                   x,
                                   y,
            ...
            struct gl_copy_tex_sub_image_1d< C1 > {
                inline static void call(std::int32_t level,
                                        ...
                                        GLsizei width) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glCopyTexSubImage1D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "width: '" << width << "'";
            ...
            struct gl_copy_tex_sub_image_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        std::int32_t y,
                                        GLsizei width) {
                  __gtulu_debug() << "call glCopyTexSubImage1D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "xoffset: '" << xoffset << "'" ", " "x: '" << x << "'" ", " "y: '" << y
                      << "'" ", " "width: '" << width << "'";
            ...
            struct gl_copy_tex_sub_image_2d< C1 > {
                inline static void call(std::int32_t level,
                                        ...
                                        GLsizei height) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glCopyTexSubImage2D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '"
                      << yoffset << "'" ", " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'";
            ...
            struct gl_copy_tex_sub_image_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei width,
                                        GLsizei height) {
                  __gtulu_debug() << "call glCopyTexSubImage2D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '" << yoffset << "'" ", " "x: '" << x
            ...
            struct gl_draw_arrays< C1 > {
                inline static void call(std::int32_t first, GLsizei count) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawArrays " "mode: '" << ModeConstant::name() << "'" ", " "first: '"
                      << first << "'" ", " "count: '" << count << "'";
            ...
            struct gl_draw_arrays< > {
                inline static void call(cst::gl_constant_base const& mode, std::int32_t first, GLsizei count) {
                  __gtulu_debug() << "call glDrawArrays " "mode: '" << mode << "'" ", " "first: '" << first
                      << "'" ", " "count: '" << count << "'";
            ...
            struct gl_draw_elements< C1, C2 > {
                inline static void call(GLsizei count, void const* indices) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawElements " "mode: '" << ModeConstant::name() << "'" ", " "count: '"
                      << count << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "indices: '" << indices << "'";
            ...
            struct gl_draw_elements< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* indices) {
                  __gtulu_debug() << "call glDrawElements " "mode: '" << mode << "'" ", " "count: '" << count
            ...
            struct gl_get_pointer< C1 > {
                inline static void call(void** params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetPointerv " "pname: '" << PnameConstant::name() << "'" ", " "params: '"
                      << params << "'";
            ...
            struct gl_tex_sub_image_1d< C1, C2, C3 > {
                inline static void call(std::int32_t level, std::int32_t xoffset, GLsizei width, void const* pixels) {
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glTexSubImage1D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "width: '"
                      << width << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "pixels: '" << pixels << "'";
                  glTexSubImage1D(TargetConstant::value,
                                  level,
                                  xoffset,
                                  width,
                                  FormatConstant::value,
            ...
            struct gl_tex_sub_image_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* pixels) {
                  __gtulu_debug() << "call glTexSubImage1D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "xoffset: '" << xoffset << "'" ", " "width: '" << width << "'" ", " "format: '"
                      << format << "'" ", " "type: '" << type << "'" ", " "pixels: '" << pixels << "'";
                  glTexSubImage1D(std::uint32_t(target),
                                  level,
                                  xoffset,
                                  width,
                                  std::uint32_t(format),
            ...
            struct gl_tex_sub_image_2d< C1, C2, C3 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glTexSubImage2D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '"
                      << yoffset << "'" ", " "width: '" << width << "'" ", " "height: '" << height
                      << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "pixels: '" << pixels << "'";
                  glTexSubImage2D(TargetConstant::value,
                                  level,
                                  xoffset,
                                  yoffset,
                                  width,
            ...
            struct gl_tex_sub_image_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* pixels) {
                  __gtulu_debug() << "call glTexSubImage2D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '" << yoffset << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'" ", " "format: '" << format << "'" ", " "type: '"
                      << type << "'" ", " "pixels: '" << pixels << "'";
                  glTexSubImage2D(std::uint32_t(target),
                                  level,
                                  xoffset,
                                  yoffset,
                                  width,
        ...
        namespace v1_2 {
          namespace function {
            ...
            struct gl_blend_color< > {
                inline static void call(float red, float green, float blue, float alpha) {
                  __gtulu_debug() << "call glBlendColor " "red: '" << red << "'" ", " "green: '" << green
                      << "'" ", " "blue: '" << blue << "'" ", " "alpha: '" << alpha << "'";
            ...
            struct gl_blend_equation< C1 > {
                ...
                inline static void call(std::uint32_t buf) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glBlendEquationi " "buf: '" << buf << "'" ", " "mode: '"
                      << ModeConstant::name() << "'";
            ...
            struct gl_copy_tex_sub_image_3d< C1 > {
                inline static void call(std::int32_t level,
                                        ...
                                        GLsizei height) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glCopyTexSubImage3D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '"
                      << yoffset << "'" ", " "zoffset: '" << zoffset << "'" ", " "x: '" << x << "'" ", " "y: '" << y
            ...
            struct gl_copy_tex_sub_image_3d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei width,
                                        GLsizei height) {
                  __gtulu_debug() << "call glCopyTexSubImage3D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '" << yoffset << "'" ", " "zoffset: '"
                      << zoffset << "'" ", " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'";
            ...
            struct gl_draw_range_elements< C1, C2 > {
                inline static void call(std::uint32_t start, std::uint32_t end, GLsizei count, void const* indices) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawRangeElements " "mode: '" << ModeConstant::name()
                      << "'" ", " "start: '" << start << "'" ", " "end: '" << end << "'" ", " "count: '" << count
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "indices: '" << indices << "'";
            ...
            struct gl_draw_range_elements< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* indices) {
                  __gtulu_debug() << "call glDrawRangeElements " "mode: '" << mode << "'" ", " "start: '" << start
                      << "'" ", " "end: '" << end << "'" ", " "count: '" << count << "'" ", " "type: '" << type
                      << "'" ", " "indices: '" << indices << "'";
            ...
            struct gl_tex_image_3d< C1, C2, C3, C4 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C3 FormatConstant;
                  typedef C4 TypeConstant;
                  __gtulu_debug() << "call glTexImage3D " "target: '" << TargetConstant::name() << "'" ", " "level: '"
                      << level << "'" ", " "internalformat: '" << InternalformatConstant::name() << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth << "'" ", " "border: '"
                      << border << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "pixels: '" << pixels << "'";
                  glTexImage3D(TargetConstant::value,
                               level,
                               InternalformatConstant::value,
                               width,
                               height,
            ...
            struct gl_tex_image_3d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* pixels) {
                  __gtulu_debug() << "call glTexImage3D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth << "'" ", " "border: '"
                      << border << "'" ", " "format: '" << format << "'" ", " "type: '" << type << "'" ", " "pixels: '"
                      << pixels << "'";
                  glTexImage3D(std::uint32_t(target),
                               level,
                               std::uint32_t(internalformat),
                               width,
                               height,
            ...
            struct gl_tex_sub_image_3d< C1, C2, C3 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glTexSubImage3D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '"
                      << yoffset << "'" ", " "zoffset: '" << zoffset << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth << "'" ", " "format: '"
                      << FormatConstant::name() << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "pixels: '"
                      << pixels << "'";
                  glTexSubImage3D(TargetConstant::value,
                                  level,
                                  xoffset,
                                  yoffset,
                                  zoffset,
            ...
            struct gl_tex_sub_image_3d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& type,
                                        void const* pixels) {
                  __gtulu_debug() << "call glTexSubImage3D " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '" << yoffset << "'" ", " "zoffset: '"
                      << zoffset << "'" ", " "width: '" << width << "'" ", " "height: '" << height
                      << "'" ", " "depth: '" << depth << "'" ", " "format: '" << format << "'" ", " "type: '" << type
                      << "'" ", " "pixels: '" << pixels << "'";
                  glTexSubImage3D(std::uint32_t(target),
                                  level,
                                  xoffset,
                                  yoffset,
                                  zoffset,
          ...
          namespace function {
            ...
            struct gl_compressed_tex_image_1d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glCompressedTexImage1D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "internalformat: '" << InternalformatConstant::name()
                      << "'" ", " "width: '" << width << "'" ", " "border: '" << border << "'" ", " "imageSize: '"
                      << imageSize << "'" ", " "data: '" << data << "'";
                  glCompressedTexImage1D(TargetConstant::value,
                                         level,
                                         InternalformatConstant::value,
                                         width,
                                         border,
            ...
            struct gl_compressed_tex_image_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei imageSize,
                                        void const* data) {
                  __gtulu_debug() << "call glCompressedTexImage1D " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "border: '" << border << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '"
                      << data << "'";
                  glCompressedTexImage1D(std::uint32_t(target),
                                         level,
                                         std::uint32_t(internalformat),
                                         width,
                                         border,
            ...
            struct gl_compressed_tex_image_2d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glCompressedTexImage2D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "internalformat: '" << InternalformatConstant::name()
                      << "'" ", " "width: '" << width << "'" ", " "height: '" << height << "'" ", " "border: '"
                      << border << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '" << data << "'";
                  glCompressedTexImage2D(TargetConstant::value,
                                         level,
                                         InternalformatConstant::value,
                                         width,
                                         height,
            ...
            struct gl_compressed_tex_image_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei imageSize,
                                        void const* data) {
                  __gtulu_debug() << "call glCompressedTexImage2D " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "border: '" << border << "'" ", " "imageSize: '"
                      << imageSize << "'" ", " "data: '" << data << "'";
                  glCompressedTexImage2D(std::uint32_t(target),
                                         level,
                                         std::uint32_t(internalformat),
                                         width,
                                         height,
            ...
            struct gl_compressed_tex_image_3d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glCompressedTexImage3D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "internalformat: '" << InternalformatConstant::name()
                      << "'" ", " "width: '" << width << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth
                      << "'" ", " "border: '" << border << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '"
                      << data << "'";
                  glCompressedTexImage3D(TargetConstant::value,
                                         level,
                                         InternalformatConstant::value,
                                         width,
                                         height,
            ...
            struct gl_compressed_tex_image_3d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei imageSize,
                                        void const* data) {
                  __gtulu_debug() << "call glCompressedTexImage3D " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth << "'" ", " "border: '"
                      << border << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '" << data << "'";
                  glCompressedTexImage3D(std::uint32_t(target),
                                         level,
                                         std::uint32_t(internalformat),
                                         width,
                                         height,
            ...
            struct gl_compressed_tex_sub_image_1d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 FormatConstant;
                  __gtulu_debug() << "call glCompressedTexSubImage1D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "width: '"
                      << width << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "imageSize: '" << imageSize
                      << "'" ", " "data: '" << data << "'";
                  glCompressedTexSubImage1D(TargetConstant::value,
                                            level,
                                            xoffset,
                                            width,
                                            FormatConstant::value,
            ...
            struct gl_compressed_tex_sub_image_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei imageSize,
                                        void const* data) {
                  __gtulu_debug() << "call glCompressedTexSubImage1D " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "width: '" << width
                      << "'" ", " "format: '" << format << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '"
                      << data << "'";
                  glCompressedTexSubImage1D(std::uint32_t(target),
                                            level,
                                            xoffset,
                                            width,
                                            std::uint32_t(format),
            ...
            struct gl_compressed_tex_sub_image_2d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 FormatConstant;
                  __gtulu_debug() << "call glCompressedTexSubImage2D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '"
                      << yoffset << "'" ", " "width: '" << width << "'" ", " "height: '" << height
                      << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "imageSize: '" << imageSize
                      << "'" ", " "data: '" << data << "'";
                  glCompressedTexSubImage2D(TargetConstant::value,
                                            level,
                                            xoffset,
                                            yoffset,
                                            width,
            ...
            struct gl_compressed_tex_sub_image_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei imageSize,
                                        void const* data) {
                  __gtulu_debug() << "call glCompressedTexSubImage2D " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '" << yoffset
                      << "'" ", " "width: '" << width << "'" ", " "height: '" << height << "'" ", " "format: '"
                      << format << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '" << data << "'";
                  glCompressedTexSubImage2D(std::uint32_t(target),
                                            level,
                                            xoffset,
                                            yoffset,
                                            width,
            ...
            struct gl_compressed_tex_sub_image_3d< C1, C2 > {
                inline static void call(std::int32_t level,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 FormatConstant;
                  __gtulu_debug() << "call glCompressedTexSubImage3D " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '"
                      << yoffset << "'" ", " "zoffset: '" << zoffset << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth << "'" ", " "format: '"
                      << FormatConstant::name() << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '" << data
                      << "'";
                  glCompressedTexSubImage3D(TargetConstant::value,
                                            level,
                                            xoffset,
                                            yoffset,
                                            zoffset,
            ...
            struct gl_compressed_tex_sub_image_3d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei imageSize,
                                        void const* data) {
                  __gtulu_debug() << "call glCompressedTexSubImage3D " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "xoffset: '" << xoffset << "'" ", " "yoffset: '" << yoffset
                      << "'" ", " "zoffset: '" << zoffset << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'" ", " "depth: '" << depth << "'" ", " "format: '" << format
                      << "'" ", " "imageSize: '" << imageSize << "'" ", " "data: '" << data << "'";
                  glCompressedTexSubImage3D(std::uint32_t(target),
                                            level,
                                            xoffset,
                                            yoffset,
                                            zoffset,
            ...
            struct gl_get_compressed_tex_image< C1 > {
                inline static void call(std::int32_t level, void* img) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetCompressedTexImage " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "img: '" << img << "'";
            ...
            struct gl_get_compressed_tex_image< > {
                inline static void call(cst::gl_constant_base const& target, std::int32_t level, void* img) {
                  __gtulu_debug() << "call glGetCompressedTexImage " "target: '" << target << "'" ", " "level: '"
                      << level << "'" ", " "img: '" << img << "'";
          ...
          namespace function {
            ...
            struct gl_blend_func_separate< C1, C2, C3, C4 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glBlendFuncSeparate " "sfactorRGB: '" << SfactorRGBConstant::name()
                      << "'" ", " "dfactorRGB: '" << DfactorRGBConstant::name() << "'" ", " "sfactorAlpha: '"
                      << SfactorAlphaConstant::name() << "'" ", " "dfactorAlpha: '" << DfactorAlphaConstant::name()
                      << "'";
                  glBlendFuncSeparate(SfactorRGBConstant::value,
                                      DfactorRGBConstant::value,
                                      SfactorAlphaConstant::value,
                                      DfactorAlphaConstant::value);
                  __gtulu_check_error();
                ...
                inline static void call(std::uint32_t buf) {
                  ...
                  __gtulu_debug() << "call glBlendFuncSeparatei " "buf: '" << buf << "'" ", " "srcRGB: '"
                      << SrcRGBConstant::name() << "'" ", " "dstRGB: '" << DstRGBConstant::name()
                      << "'" ", " "srcAlpha: '" << SrcAlphaConstant::name() << "'" ", " "dstAlpha: '"
                      << DstAlphaConstant::name() << "'";
                  glBlendFuncSeparatei(buf,
                                       SrcRGBConstant::value,
                                       DstRGBConstant::value,
                                       SrcAlphaConstant::value,
                                       DstAlphaConstant::value);
                  __gtulu_check_error();
            ...
            struct gl_blend_func_separate< > {
                inline static void call(cst::gl_constant_base const& sfactorRGB,
                                        cst::gl_constant_base const& dfactorRGB,
                                        cst::gl_constant_base const& sfactorAlpha,
                                        cst::gl_constant_base const& dfactorAlpha) {
                  __gtulu_debug() << "call glBlendFuncSeparate " "sfactorRGB: '" << sfactorRGB
                      << "'" ", " "dfactorRGB: '" << dfactorRGB << "'" ", " "sfactorAlpha: '" << sfactorAlpha
                      << "'" ", " "dfactorAlpha: '" << dfactorAlpha << "'";
                  glBlendFuncSeparate(std::uint32_t(sfactorRGB),
                                      std::uint32_t(dfactorRGB),
                                      std::uint32_t(sfactorAlpha),
                                      std::uint32_t(dfactorAlpha));
                  __gtulu_check_error();

                }

                inline static void call(std::uint32_t buf,
                                        cst::gl_constant_base const& srcRGB,
                                        cst::gl_constant_base const& dstRGB,
                                        cst::gl_constant_base const& srcAlpha,
                                        cst::gl_constant_base const& dstAlpha) {
                  __gtulu_debug() << "call glBlendFuncSeparatei " "buf: '" << buf << "'" ", " "srcRGB: '" << srcRGB
                      << "'" ", " "dstRGB: '" << dstRGB << "'" ", " "srcAlpha: '" << srcAlpha << "'" ", " "dstAlpha: '"
                      << dstAlpha << "'";
                  glBlendFuncSeparatei(buf,
                                       std::uint32_t(srcRGB),
                                       std::uint32_t(dstRGB),
                                       std::uint32_t(srcAlpha),
            ...
            struct gl_multi_draw_arrays< C1 > {
                inline static void call(std::int32_t const* first, GLsizei const* count, GLsizei primcount) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glMultiDrawArrays " "mode: '" << ModeConstant::name() << "'" ", " "first: '"
                      << first << "'" ", " "count: '" << count << "'" ", " "primcount: '" << primcount << "'";
            ...
            struct gl_multi_draw_arrays< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        std::int32_t const* first,
                                        GLsizei const* count,
                                        GLsizei primcount) {
                  __gtulu_debug() << "call glMultiDrawArrays " "mode: '" << mode << "'" ", " "first: '" << first
                      << "'" ", " "count: '" << count << "'" ", " "primcount: '" << primcount << "'";
            ...
            struct gl_multi_draw_elements< C1, C2 > {
                inline static void call(GLsizei const* count, void const** indices, GLsizei primcount) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiDrawElements " "mode: '" << ModeConstant::name()
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "indices: '" << indices << "'" ", " "primcount: '" << primcount << "'";
            ...
            struct gl_multi_draw_elements< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        void const** indices,
                                        GLsizei primcount) {
                  __gtulu_debug() << "call glMultiDrawElements " "mode: '" << mode << "'" ", " "count: '" << count
                      << "'" ", " "type: '" << type << "'" ", " "indices: '" << indices << "'" ", " "primcount: '"
                      << primcount << "'";
            ...
            struct gl_point_parameter< C1 > {
                inline static void call(float param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPointParameterf " "pname: '" << PnameConstant::name()
                      << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(float const* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPointParameterfv " "pname: '" << PnameConstant::name()
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::int32_t param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPointParameteri " "pname: '" << PnameConstant::name()
                      << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(std::int32_t const* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPointParameteriv " "pname: '" << PnameConstant::name()
                      << "'" ", " "params: '" << params << "'";
          ...
          namespace function {
            ...
            struct gl_begin_query< C1 > {
                inline static void call(std::uint32_t id) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBeginQuery " "target: '" << TargetConstant::name() << "'" ", " "id: '"
                      << id << "'";
            ...
            struct gl_bind_buffer< C1 > {
                inline static void call(std::uint32_t buffer) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBindBuffer " "target: '" << TargetConstant::name() << "'" ", " "buffer: '"
                      << buffer << "'";
            ...
            struct gl_buffer_data< C1, C2 > {
                inline static void call(GLsizeiptr size, void const* data) {
                  ...
                  __gtulu_debug() << "call glBufferData " "target: '" << TargetConstant::name() << "'" ", " "size: '"
                      << size << "'" ", " "data: '" << data << "'" ", " "usage: '" << UsageConstant::name() << "'";
            ...
            struct gl_buffer_data< > {
                inline static void call(cst::gl_constant_base const& target,
                                        GLsizeiptr size,
                                        void const* data,
                                        cst::gl_constant_base const& usage) {
                  __gtulu_debug() << "call glBufferData " "target: '" << target << "'" ", " "size: '" << size
            ...
            struct gl_buffer_sub_data< C1 > {
                inline static void call(GLintptr offset, GLsizeiptr size, void const* data) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBufferSubData " "target: '" << TargetConstant::name()
            ...
            struct gl_buffer_sub_data< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizeiptr size,
                                        void const* data) {
                  __gtulu_debug() << "call glBufferSubData " "target: '" << target << "'" ", " "offset: '" << offset
                      << "'" ", " "size: '" << size << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_buffer_parameter< C1, C2 > {
                inline static void call(std::int32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetBufferParameteriv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(GLint64* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetBufferParameteri64v " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_buffer_parameter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetBufferParameteriv " "target: '" << target << "'" ", " "pname: '"
                      << pname << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        GLint64* params) {
                  __gtulu_debug() << "call glGetBufferParameteri64v " "target: '" << target << "'" ", " "pname: '"
                      << pname << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_buffer_pointer< C1, C2 > {
                inline static void call(void** params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetBufferPointerv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_buffer_pointer< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        void** params) {
                  __gtulu_debug() << "call glGetBufferPointerv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_buffer_sub_data< C1 > {
                inline static void call(GLintptr offset, GLsizeiptr size, void* data) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetBufferSubData " "target: '" << TargetConstant::name()
                      << "'" ", " "offset: '" << offset << "'" ", " "size: '" << size << "'" ", " "data: '" << data
                      << "'";
            ...
            struct gl_get_buffer_sub_data< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizeiptr size,
                                        void* data) {
                  __gtulu_debug() << "call glGetBufferSubData " "target: '" << target << "'" ", " "offset: '" << offset
                      << "'" ", " "size: '" << size << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_query< C1, C2 > {
                inline static void call(std::int32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetQueryiv " "target: '" << TargetConstant::name() << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_query< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetQueryiv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_query_object< C1 > {
                inline static void call(std::uint32_t id, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetQueryObjectiv " "id: '" << id << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t id, std::uint32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetQueryObjectuiv " "id: '" << id << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t id, GLint64* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetQueryObjecti64v " "id: '" << id << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t id, GLuint64* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetQueryObjectui64v " "id: '" << id << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_query_object< > {
                inline static void call(std::uint32_t id, cst::gl_constant_base const& pname, std::int32_t* params) {
                  __gtulu_debug() << "call glGetQueryObjectiv " "id: '" << id << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t id, cst::gl_constant_base const& pname, std::uint32_t* params) {
                  __gtulu_debug() << "call glGetQueryObjectuiv " "id: '" << id << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t id, cst::gl_constant_base const& pname, GLint64* params) {
                  __gtulu_debug() << "call glGetQueryObjecti64v " "id: '" << id << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t id, cst::gl_constant_base const& pname, GLuint64* params) {
                  __gtulu_debug() << "call glGetQueryObjectui64v " "id: '" << id << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_map_buffer< C1, C2 > {
                inline static GLvoid* call() {
                  ...
                  __gtulu_debug() << "call glMapBuffer " "target: '" << TargetConstant::name() << "'" ", " "access: '"
                      << AccessConstant::name() << "'";
          ...
          namespace function {
            ...
            struct gl_bind_attrib_location< > {
                inline static void call(std::uint32_t program, std::uint32_t index, GLchar const* name) {
                  __gtulu_debug() << "call glBindAttribLocation " "program: '" << program << "'" ", " "index: '"
                      << index << "'" ", " "name: '" << name << "'";
            ...
            struct gl_blend_equation_separate< C1, C2 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glBlendEquationSeparate " "modeRGB: '" << ModeRGBConstant::name()
                      << "'" ", " "modeAlpha: '" << ModeAlphaConstant::name() << "'";
                ...
                inline static void call(std::uint32_t buf) {
                  typedef C1 ModeRGBConstant;
                  typedef C2 ModeAlphaConstant;
                  __gtulu_debug() << "call glBlendEquationSeparatei " "buf: '" << buf << "'" ", " "modeRGB: '"
                      << ModeRGBConstant::name() << "'" ", " "modeAlpha: '" << ModeAlphaConstant::name() << "'";
            ...
            struct gl_blend_equation_separate< > {
                inline static void call(cst::gl_constant_base const& modeRGB, cst::gl_constant_base const& modeAlpha) {
                  __gtulu_debug() << "call glBlendEquationSeparate " "modeRGB: '" << modeRGB << "'" ", " "modeAlpha: '"
                      << modeAlpha << "'";
                ...
                inline static void call(std::uint32_t buf,
                                        cst::gl_constant_base const& modeRGB,
                                        cst::gl_constant_base const& modeAlpha) {
                  __gtulu_debug() << "call glBlendEquationSeparatei " "buf: '" << buf << "'" ", " "modeRGB: '"
                      << modeRGB << "'" ", " "modeAlpha: '" << modeAlpha << "'";
            ...
            struct gl_get_active_attrib< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLenum* type,
                                        GLchar* name) {
                  __gtulu_debug() << "call glGetActiveAttrib " "program: '" << program << "'" ", " "index: '" << index
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "length: '" << length << "'" ", " "size: '"
            ...
            struct gl_get_active_uniform< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLenum* type,
                                        GLchar* name) {
                  __gtulu_debug() << "call glGetActiveUniform " "program: '" << program << "'" ", " "index: '" << index
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "length: '" << length << "'" ", " "size: '"
                      << size << "'" ", " "type: '" << type << "'" ", " "name: '" << name << "'";
            ...
            struct gl_get_attached_shaders< > {
                inline static void call(std::uint32_t program, GLsizei maxCount, GLsizei* count, std::uint32_t* obj) {
                  __gtulu_debug() << "call glGetAttachedShaders " "program: '" << program << "'" ", " "maxCount: '"
                      << maxCount << "'" ", " "count: '" << count << "'" ", " "obj: '" << obj << "'";
            ...
            struct gl_get_program< C1 > {
                inline static void call(std::uint32_t program, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetProgramiv " "program: '" << program << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_program< > {
                inline static void call(std::uint32_t program,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetProgramiv " "program: '" << program << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_program_info_log< > {
                inline static void call(std::uint32_t program, GLsizei bufSize, GLsizei* length, GLchar* infoLog) {
                  __gtulu_debug() << "call glGetProgramInfoLog " "program: '" << program << "'" ", " "bufSize: '"
                      << bufSize << "'" ", " "length: '" << length << "'" ", " "infoLog: '" << infoLog << "'";
            ...
            struct gl_get_shader< C1 > {
                inline static void call(std::uint32_t shader, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetShaderiv " "shader: '" << shader << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_shader< > {
                inline static void call(std::uint32_t shader,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetShaderiv " "shader: '" << shader << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_shader_info_log< > {
                inline static void call(std::uint32_t shader, GLsizei bufSize, GLsizei* length, GLchar* infoLog) {
                  __gtulu_debug() << "call glGetShaderInfoLog " "shader: '" << shader << "'" ", " "bufSize: '"
                      << bufSize << "'" ", " "length: '" << length << "'" ", " "infoLog: '" << infoLog << "'";
            ...
            struct gl_get_shader_source< > {
                inline static void call(std::uint32_t shader, GLsizei bufSize, GLsizei* length, GLchar* source) {
                  __gtulu_debug() << "call glGetShaderSource " "shader: '" << shader << "'" ", " "bufSize: '" << bufSize
            ...
            struct gl_get_uniform< > {
                inline static void call(std::uint32_t program, std::int32_t location, float* params) {
                  __gtulu_debug() << "call glGetUniformfv " "program: '" << program << "'" ", " "location: '"
                ...
                inline static void call(std::uint32_t program, std::int32_t location, std::int32_t* params) {
                  __gtulu_debug() << "call glGetUniformiv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, std::uint32_t* params) {
                  __gtulu_debug() << "call glGetUniformuiv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, double* params) {
                  __gtulu_debug() << "call glGetUniformdv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_vertex_attrib< C1 > {
                inline static void call(std::uint32_t index, double* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetVertexAttribdv " "index: '" << index << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t index, float* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetVertexAttribfv " "index: '" << index << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t index, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetVertexAttribiv " "index: '" << index << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_vertex_attrib< > {
                inline static void call(std::uint32_t index, cst::gl_constant_base const& pname, double* params) {
                  __gtulu_debug() << "call glGetVertexAttribdv " "index: '" << index << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t index, cst::gl_constant_base const& pname, float* params) {
                  __gtulu_debug() << "call glGetVertexAttribfv " "index: '" << index << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t index, cst::gl_constant_base const& pname, std::int32_t* params) {
                  __gtulu_debug() << "call glGetVertexAttribiv " "index: '" << index << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_vertex_attrib_pointer< C1 > {
                inline static void call(std::uint32_t index, void** pointer) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetVertexAttribPointerv " "index: '" << index << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "pointer: '" << pointer << "'";
            ...
            struct gl_shader_source< > {
                inline static void call(std::uint32_t shader,
                  ...
                  __gtulu_debug() << "call glShaderSource " "shader: '" << shader << "'" ", " "count: '" << count
            ...
            struct gl_stencil_func_separate< C1, C2 > {
                inline static void call(std::int32_t ref, std::uint32_t mask) {
                  ...
                  __gtulu_debug() << "call glStencilFuncSeparate " "face: '" << FaceConstant::name()
                      << "'" ", " "func: '" << FuncConstant::name() << "'" ", " "ref: '" << ref << "'" ", " "mask: '"
                      << mask << "'";
            ...
            struct gl_stencil_func_separate< > {
                inline static void call(cst::gl_constant_base const& face,
                                        cst::gl_constant_base const& func,
                                        std::int32_t ref,
                                        std::uint32_t mask) {
                  __gtulu_debug() << "call glStencilFuncSeparate " "face: '" << face << "'" ", " "func: '" << func
                      << "'" ", " "ref: '" << ref << "'" ", " "mask: '" << mask << "'";
            ...
            struct gl_stencil_mask_separate< C1 > {
                inline static void call(std::uint32_t mask) {
                  typedef C1 FaceConstant;
                  __gtulu_debug() << "call glStencilMaskSeparate " "face: '" << FaceConstant::name()
                      << "'" ", " "mask: '" << mask << "'";
            ...
            struct gl_stencil_op_separate< C1, C2, C3, C4 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glStencilOpSeparate " "face: '" << FaceConstant::name()
                      << "'" ", " "sfail: '" << SfailConstant::name() << "'" ", " "dpfail: '" << DpfailConstant::name()
                      << "'" ", " "dppass: '" << DppassConstant::name() << "'";
                  glStencilOpSeparate(FaceConstant::value,
                                      SfailConstant::value,
                                      DpfailConstant::value,
                                      DppassConstant::value);
                  __gtulu_check_error();
            ...
            struct gl_stencil_op_separate< > {
                inline static void call(cst::gl_constant_base const& face,
                                        cst::gl_constant_base const& sfail,
                                        cst::gl_constant_base const& dpfail,
                                        cst::gl_constant_base const& dppass) {
                  __gtulu_debug() << "call glStencilOpSeparate " "face: '" << face << "'" ", " "sfail: '" << sfail
                      << "'" ", " "dpfail: '" << dpfail << "'" ", " "dppass: '" << dppass << "'";
                  glStencilOpSeparate(std::uint32_t(face),
                                      std::uint32_t(sfail),
                                      std::uint32_t(dpfail),
                                      std::uint32_t(dppass));
                  __gtulu_check_error();
            ...
            struct gl_uniform_1< > {
                ...
                inline static void call(std::int32_t location, GLsizei count, float const* value) {
                  __gtulu_debug() << "call glUniform1fv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::int32_t const* value) {
                  __gtulu_debug() << "call glUniform1iv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::uint32_t const* value) {
                  __gtulu_debug() << "call glUniform1uiv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, double const* value) {
                  __gtulu_debug() << "call glUniform1dv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_2< > {
                inline static void call(std::int32_t location, float v0, float v1) {
                  __gtulu_debug() << "call glUniform2f " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'";
                ...
                inline static void call(std::int32_t location, std::int32_t v0, std::int32_t v1) {
                  __gtulu_debug() << "call glUniform2i " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, float const* value) {
                  __gtulu_debug() << "call glUniform2fv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::int32_t const* value) {
                  __gtulu_debug() << "call glUniform2iv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, std::uint32_t v0, std::uint32_t v1) {
                  __gtulu_debug() << "call glUniform2ui " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::uint32_t const* value) {
                  __gtulu_debug() << "call glUniform2uiv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, double x, double y) {
                  __gtulu_debug() << "call glUniform2d " "location: '" << location << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, double const* value) {
                  __gtulu_debug() << "call glUniform2dv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_3< > {
                inline static void call(std::int32_t location, float v0, float v1, float v2) {
                  __gtulu_debug() << "call glUniform3f " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'";
                ...
                inline static void call(std::int32_t location, std::int32_t v0, std::int32_t v1, std::int32_t v2) {
                  __gtulu_debug() << "call glUniform3i " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, float const* value) {
                  __gtulu_debug() << "call glUniform3fv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::int32_t const* value) {
                  __gtulu_debug() << "call glUniform3iv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, std::uint32_t v0, std::uint32_t v1, std::uint32_t v2) {
                  __gtulu_debug() << "call glUniform3ui " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::uint32_t const* value) {
                  __gtulu_debug() << "call glUniform3uiv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, double x, double y, double z) {
                  __gtulu_debug() << "call glUniform3d " "location: '" << location << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, double const* value) {
                  __gtulu_debug() << "call glUniform3dv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_4< > {
                inline static void call(std::int32_t location, float v0, float v1, float v2, float v3) {
                  __gtulu_debug() << "call glUniform4f " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'" ", " "v3: '" << v3 << "'";
                ...
                inline static void call(std::int32_t location,
                                        std::int32_t v0,
                                        std::int32_t v1,
                                        std::int32_t v2,
                                        std::int32_t v3) {
                  __gtulu_debug() << "call glUniform4i " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'" ", " "v3: '" << v3 << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, float const* value) {
                  __gtulu_debug() << "call glUniform4fv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::int32_t const* value) {
                  __gtulu_debug() << "call glUniform4iv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location,
                                        ...
                                        std::uint32_t v2,
                                        std::uint32_t v3) {
                  __gtulu_debug() << "call glUniform4ui " "location: '" << location << "'" ", " "v0: '" << v0
                      << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'" ", " "v3: '" << v3 << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, std::uint32_t const* value) {
                  __gtulu_debug() << "call glUniform4uiv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, double x, double y, double z, double w) {
                  __gtulu_debug() << "call glUniform4d " "location: '" << location << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, double const* value) {
                  __gtulu_debug() << "call glUniform4dv " "location: '" << location << "'" ", " "count: '" << count
                      << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_2< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix2fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix2dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_3< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix3fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix3dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_4< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix4fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix4dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_vertex_attrib_2< > {
                inline static void call(std::uint32_t index, double x, double y) {
                  __gtulu_debug() << "call glVertexAttrib2d " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'";
                ...
                inline static void call(std::uint32_t index, float x, float y) {
                  __gtulu_debug() << "call glVertexAttrib2f " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'";
                ...
                inline static void call(std::uint32_t index, GLshort x, GLshort y) {
                  __gtulu_debug() << "call glVertexAttrib2s " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'";
            ...
            struct gl_vertex_attrib_3< > {
                inline static void call(std::uint32_t index, double x, double y, double z) {
                  __gtulu_debug() << "call glVertexAttrib3d " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'";
                ...
                inline static void call(std::uint32_t index, float x, float y, float z) {
                  __gtulu_debug() << "call glVertexAttrib3f " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'";
                ...
                inline static void call(std::uint32_t index, GLshort x, GLshort y, GLshort z) {
                  __gtulu_debug() << "call glVertexAttrib3s " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'";
            ...
            struct gl_vertex_attrib_4< > {
                ...
                inline static void call(std::uint32_t index, double x, double y, double z, double w) {
                  __gtulu_debug() << "call glVertexAttrib4d " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
                ...
                inline static void call(std::uint32_t index, float x, float y, float z, float w) {
                  __gtulu_debug() << "call glVertexAttrib4f " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
                ...
                inline static void call(std::uint32_t index, GLshort x, GLshort y, GLshort z, GLshort w) {
                  __gtulu_debug() << "call glVertexAttrib4s " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
            ...
            struct gl_vertex_attrib_4_normalized< > {
                ...
                inline static void call(std::uint32_t index,
                                        ...
                                        std::uint8_t z,
                                        std::uint8_t w) {
                  __gtulu_debug() << "call glVertexAttrib4Nub " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
            ...
            struct gl_vertex_attrib_pointer< C1 > {
                inline static void call(std::uint32_t index,
                                        ...
                                        void const* pointer) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribPointer " "index: '" << index << "'" ", " "size: '" << size
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "normalized: '" << normalized
            ...
            struct gl_vertex_attrib_pointer< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        void const* pointer) {
                  __gtulu_debug() << "call glVertexAttribPointer " "index: '" << index << "'" ", " "size: '" << size
                      << "'" ", " "type: '" << type << "'" ", " "normalized: '" << normalized << "'" ", " "stride: '"
        ...
        namespace v2_1 {
          namespace function {
            ...
            struct gl_uniform_matrix_2x3< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix2x3fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix2x3dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_2x4< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix2x4fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix2x4dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_3x2< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix3x2fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix3x2dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_3x4< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix3x4fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix3x4dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_4x2< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix4x2fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix4x2dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_uniform_matrix_4x3< > {
                inline static void call(std::int32_t location, GLsizei count, bool transpose, float const* value) {
                  __gtulu_debug() << "call glUniformMatrix4x3fv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t location, GLsizei count, bool transpose, double const* value) {
                  __gtulu_debug() << "call glUniformMatrix4x3dv " "location: '" << location << "'" ", " "count: '"
                      << count << "'" ", " "transpose: '" << transpose << "'" ", " "value: '" << value << "'";
        ...
        namespace v3_0 {
          namespace function {
            ...
            struct gl_begin_conditional_render< C1 > {
                inline static void call(std::uint32_t id) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glBeginConditionalRender " "id: '" << id << "'" ", " "mode: '"
                      << ModeConstant::name() << "'";
            ...
            struct gl_begin_transform_feedback< C1 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glBeginTransformFeedback " "primitiveMode: '"
                      << PrimitiveModeConstant::name() << "'";
            ...
            struct gl_bind_buffer_base< C1 > {
                inline static void call(std::uint32_t index, std::uint32_t buffer) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBindBufferBase " "target: '" << TargetConstant::name()
            ...
            struct gl_bind_buffer_base< > {
                inline static void call(cst::gl_constant_base const& target,
                                        std::uint32_t index,
                                        std::uint32_t buffer) {
                  __gtulu_debug() << "call glBindBufferBase " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "buffer: '" << buffer << "'";
            ...
            struct gl_bind_buffer_range< C1 > {
                inline static void call(std::uint32_t index, std::uint32_t buffer, GLintptr offset, GLsizeiptr size) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBindBufferRange " "target: '" << TargetConstant::name()
                      << "'" ", " "index: '" << index << "'" ", " "buffer: '" << buffer << "'" ", " "offset: '"
                      << offset << "'" ", " "size: '" << size << "'";
            ...
            struct gl_bind_buffer_range< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLintptr offset,
                                        GLsizeiptr size) {
                  __gtulu_debug() << "call glBindBufferRange " "target: '" << target << "'" ", " "index: '" << index
            ...
            struct gl_bind_frag_data_location< > {
                inline static void call(std::uint32_t program, std::uint32_t color, GLchar const* name) {
                  __gtulu_debug() << "call glBindFragDataLocation " "program: '" << program << "'" ", " "color: '"
                      << color << "'" ", " "name: '" << name << "'";
            ...
            struct gl_clamp_color< C1, C2 > {
                inline static void call() {
                  ...
                  __gtulu_debug() << "call glClampColor " "target: '" << TargetConstant::name() << "'" ", " "clamp: '"
                      << ClampConstant::name() << "'";
            ...
            struct gl_clear_buffer< C1 > {
                inline static void call(std::int32_t drawbuffer, std::int32_t const* value) {
                  ...
                  __gtulu_debug() << "call glClearBufferiv " "buffer: '" << BufferConstant::name()
                      << "'" ", " "drawbuffer: '" << drawbuffer << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t drawbuffer, std::uint32_t const* value) {
                  typedef C1 BufferConstant;
                  __gtulu_debug() << "call glClearBufferuiv " "buffer: '" << BufferConstant::name()
                      << "'" ", " "drawbuffer: '" << drawbuffer << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::int32_t drawbuffer, float const* value) {
                  typedef C1 BufferConstant;
                  __gtulu_debug() << "call glClearBufferfv " "buffer: '" << BufferConstant::name()
                      << "'" ", " "drawbuffer: '" << drawbuffer << "'" ", " "value: '" << value << "'";
            ...
            struct gl_clear_buffer< > {
                inline static void call(cst::gl_constant_base const& buffer,
                                        std::int32_t drawbuffer,
                                        std::int32_t const* value) {
                  __gtulu_debug() << "call glClearBufferiv " "buffer: '" << buffer << "'" ", " "drawbuffer: '"
                      << drawbuffer << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(cst::gl_constant_base const& buffer,
                  ...
                  __gtulu_debug() << "call glClearBufferuiv " "buffer: '" << buffer << "'" ", " "drawbuffer: '"
                      << drawbuffer << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(cst::gl_constant_base const& buffer,
                                        std::int32_t drawbuffer,
                                        float const* value) {
                  __gtulu_debug() << "call glClearBufferfv " "buffer: '" << buffer << "'" ", " "drawbuffer: '"
                      << drawbuffer << "'" ", " "value: '" << value << "'";
            ...
            struct gl_clear_buffer_float< C1 > {
                inline static void call(std::int32_t drawbuffer, float depth, std::int32_t stencil) {
                  typedef C1 BufferConstant;
                  __gtulu_debug() << "call glClearBufferfi " "buffer: '" << BufferConstant::name()
                      << "'" ", " "drawbuffer: '" << drawbuffer << "'" ", " "depth: '" << depth << "'" ", " "stencil: '"
                      << stencil << "'";
            ...
            struct gl_clear_buffer_float< > {
                inline static void call(cst::gl_constant_base const& buffer,
                                        ...
                                        float depth,
                                        std::int32_t stencil) {
                  __gtulu_debug() << "call glClearBufferfi " "buffer: '" << buffer << "'" ", " "drawbuffer: '"
                      << drawbuffer << "'" ", " "depth: '" << depth << "'" ", " "stencil: '" << stencil << "'";
            ...
            struct gl_get_boolean_indexed< C1 > {
                inline static void call(std::uint32_t index, GLboolean* data) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetBooleani_v " "target: '" << TargetConstant::name()
            ...
            struct gl_get_boolean_indexed< > {
                inline static void call(cst::gl_constant_base const& target, std::uint32_t index, GLboolean* data) {
                  __gtulu_debug() << "call glGetBooleani_v " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_integer_indexed< C1 > {
                inline static void call(std::uint32_t index, std::int32_t* data) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetIntegeri_v " "target: '" << TargetConstant::name()
                      << "'" ", " "index: '" << index << "'" ", " "data: '" << data << "'";
                ...
                inline static void call(std::uint32_t index, GLint64* data) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetInteger64i_v " "target: '" << TargetConstant::name()
                      << "'" ", " "index: '" << index << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_integer_indexed< > {
                inline static void call(cst::gl_constant_base const& target, std::uint32_t index, std::int32_t* data) {
                  __gtulu_debug() << "call glGetIntegeri_v " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "data: '" << data << "'";
                ...
                inline static void call(cst::gl_constant_base const& target, std::uint32_t index, GLint64* data) {
                  __gtulu_debug() << "call glGetInteger64i_v " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_tex_parameter_integer< C1, C2 > {
                inline static void call(std::int32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetTexParameterIiv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetTexParameterIuiv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_tex_parameter_integer< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetTexParameterIiv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::uint32_t* params) {
                  __gtulu_debug() << "call glGetTexParameterIuiv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_transform_feedback_varying< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLenum* type,
                                        GLchar* name) {
                  __gtulu_debug() << "call glGetTransformFeedbackVarying " "program: '" << program
                      << "'" ", " "index: '" << index << "'" ", " "bufSize: '" << bufSize << "'" ", " "length: '"
                      << length << "'" ", " "size: '" << size << "'" ", " "type: '" << type << "'" ", " "name: '"
                      << name << "'";
            ...
            struct gl_get_vertex_attrib_integer< C1 > {
                inline static void call(std::uint32_t index, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetVertexAttribIiv " "index: '" << index << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t index, std::uint32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetVertexAttribIuiv " "index: '" << index << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_vertex_attrib_integer< > {
                inline static void call(std::uint32_t index, cst::gl_constant_base const& pname, std::int32_t* params) {
                  __gtulu_debug() << "call glGetVertexAttribIiv " "index: '" << index << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t index,
                                        cst::gl_constant_base const& pname,
                                        std::uint32_t* params) {
                  __gtulu_debug() << "call glGetVertexAttribIuiv " "index: '" << index << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_tex_parameter_integer< C1, C2 > {
                inline static void call(std::int32_t const* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glTexParameterIiv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t const* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glTexParameterIuiv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_tex_parameter_integer< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t const* params) {
                  __gtulu_debug() << "call glTexParameterIiv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::uint32_t const* params) {
                  __gtulu_debug() << "call glTexParameterIuiv " "target: '" << target << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_transform_feedback_varyings< C1 > {
                inline static void call(std::uint32_t program, GLsizei count, GLchar const** varyings) {
                  ...
                  __gtulu_debug() << "call glTransformFeedbackVaryings " "program: '" << program << "'" ", " "count: '"
                      << count << "'" ", " "varyings: '" << varyings << "'" ", " "bufferMode: '"
                      << BufferModeConstant::name() << "'";
            ...
            struct gl_transform_feedback_varyings< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        cst::gl_constant_base const& bufferMode) {
                  __gtulu_debug() << "call glTransformFeedbackVaryings " "program: '" << program << "'" ", " "count: '"
                      << count << "'" ", " "varyings: '" << varyings << "'" ", " "bufferMode: '" << bufferMode << "'";
            ...
            struct gl_vertex_attrib_2_integer< > {
                inline static void call(std::uint32_t index, std::int32_t x, std::int32_t y) {
                  __gtulu_debug() << "call glVertexAttribI2i " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'";
                ...
                inline static void call(std::uint32_t index, std::uint32_t x, std::uint32_t y) {
                  __gtulu_debug() << "call glVertexAttribI2ui " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'";
            ...
            struct gl_vertex_attrib_3_integer< > {
                inline static void call(std::uint32_t index, std::int32_t x, std::int32_t y, std::int32_t z) {
                  __gtulu_debug() << "call glVertexAttribI3i " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'";
                ...
                inline static void call(std::uint32_t index, std::uint32_t x, std::uint32_t y, std::uint32_t z) {
                  __gtulu_debug() << "call glVertexAttribI3ui " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'";
            ...
            struct gl_vertex_attrib_4_integer< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        std::int32_t z,
                                        std::int32_t w) {
                  __gtulu_debug() << "call glVertexAttribI4i " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
                ...
                inline static void call(std::uint32_t index,
                                        ...
                                        std::uint32_t z,
                                        std::uint32_t w) {
                  __gtulu_debug() << "call glVertexAttribI4ui " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
            ...
            struct gl_vertex_attrib_pointer_integer< C1 > {
                inline static void call(std::uint32_t index, std::int32_t size, GLsizei stride, void const* pointer) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribIPointer " "index: '" << index << "'" ", " "size: '" << size
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "stride: '" << stride
                      << "'" ", " "pointer: '" << pointer << "'";
            ...
            struct gl_vertex_attrib_pointer_integer< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        void const* pointer) {
                  __gtulu_debug() << "call glVertexAttribIPointer " "index: '" << index << "'" ", " "size: '" << size
                      << "'" ", " "type: '" << type << "'" ", " "stride: '" << stride << "'" ", " "pointer: '"
                      << pointer << "'";
          ...
          namespace function {
            ...
            struct gl_draw_arrays_instanced< C1 > {
                inline static void call(std::int32_t first, GLsizei count, GLsizei primcount) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawArraysInstanced " "mode: '" << ModeConstant::name()
                      << "'" ", " "first: '" << first << "'" ", " "count: '" << count << "'" ", " "primcount: '"
                      << primcount << "'";
            ...
            struct gl_draw_arrays_instanced< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        GLsizei count,
                                        GLsizei primcount) {
                  __gtulu_debug() << "call glDrawArraysInstanced " "mode: '" << mode << "'" ", " "first: '" << first
                      << "'" ", " "count: '" << count << "'" ", " "primcount: '" << primcount << "'";
            ...
            struct gl_draw_elements_instanced< C1, C2 > {
                inline static void call(GLsizei count, void const* indices, GLsizei primcount) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawElementsInstanced " "mode: '" << ModeConstant::name()
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "indices: '" << indices << "'" ", " "primcount: '" << primcount << "'";
            ...
            struct gl_draw_elements_instanced< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        void const* indices,
                                        GLsizei primcount) {
                  __gtulu_debug() << "call glDrawElementsInstanced " "mode: '" << mode << "'" ", " "count: '" << count
                      << "'" ", " "type: '" << type << "'" ", " "indices: '" << indices << "'" ", " "primcount: '"
                      << primcount << "'";
            ...
            struct gl_tex_buffer< C1, C2 > {
                inline static void call(std::uint32_t buffer) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTexBuffer " "target: '" << TargetConstant::name()
                      << "'" ", " "internalformat: '" << InternalformatConstant::name() << "'" ", " "buffer: '"
                      << buffer << "'";
            ...
            struct gl_tex_buffer< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& internalformat,
                                        std::uint32_t buffer) {
                  __gtulu_debug() << "call glTexBuffer " "target: '" << target << "'" ", " "internalformat: '"
                      << internalformat << "'" ", " "buffer: '" << buffer << "'";
          ...
          namespace function {
            ...
            struct gl_framebuffer_texture< C1, C2 > {
                inline static void call(std::uint32_t texture, std::int32_t level) {
                  ...
                  __gtulu_debug() << "call glFramebufferTexture " "target: '" << TargetConstant::name()
                      << "'" ", " "attachment: '" << AttachmentConstant::name() << "'" ", " "texture: '" << texture
                      << "'" ", " "level: '" << level << "'";
            ...
            struct gl_framebuffer_texture< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& attachment,
                                        std::uint32_t texture,
                                        std::int32_t level) {
                  __gtulu_debug() << "call glFramebufferTexture " "target: '" << target << "'" ", " "attachment: '"
                      << attachment << "'" ", " "texture: '" << texture << "'" ", " "level: '" << level << "'";
          ...
          namespace function {
            ...
            struct gl_vertex_attrib_divisor< > {
                inline static void call(std::uint32_t index, std::uint32_t divisor) {
                  __gtulu_debug() << "call glVertexAttribDivisor " "index: '" << index << "'" ", " "divisor: '"
                      << divisor << "'";
          ...
          namespace function {
            ...
            struct gl_get_shader_precision_format< C1, C2 > {
                inline static void call(std::int32_t* range, std::int32_t* precision) {
                  ...
                  __gtulu_debug() << "call glGetShaderPrecisionFormat " "shadertype: '" << ShadertypeConstant::name()
                      << "'" ", " "precisiontype: '" << PrecisiontypeConstant::name() << "'" ", " "range: '" << range
                      << "'" ", " "precision: '" << precision << "'";
            ...
            struct gl_get_shader_precision_format< > {
                inline static void call(cst::gl_constant_base const& shadertype,
                                        cst::gl_constant_base const& precisiontype,
                                        std::int32_t* range,
                                        std::int32_t* precision) {
                  __gtulu_debug() << "call glGetShaderPrecisionFormat " "shadertype: '" << shadertype
                      << "'" ", " "precisiontype: '" << precisiontype << "'" ", " "range: '" << range
                      << "'" ", " "precision: '" << precision << "'";
            ...
            struct gl_shader_binary< C1 > {
                inline static void call(GLsizei count,
                                        std::uint32_t const* shaders,
                                        void const* binary,
                                        GLsizei length) {
                  typedef C1 BinaryformatConstant;
                  __gtulu_debug() << "call glShaderBinary " "count: '" << count << "'" ", " "shaders: '" << shaders
                      << "'" ", " "binaryformat: '" << BinaryformatConstant::name() << "'" ", " "binary: '" << binary
                      << "'" ", " "length: '" << length << "'";
            ...
            struct gl_shader_binary< > {
                inline static void call(GLsizei count,
                                        std::uint32_t const* shaders,
                                        cst::gl_constant_base const& binaryformat,
                                        void const* binary,
                                        GLsizei length) {
                  __gtulu_debug() << "call glShaderBinary " "count: '" << count << "'" ", " "shaders: '" << shaders
                      << "'" ", " "binaryformat: '" << binaryformat << "'" ", " "binary: '" << binary
                      << "'" ", " "length: '" << length << "'";
        ...
        namespace base_instance {
          namespace function {
            ...
            struct gl_draw_arrays_instanced_base_instance< C1 > {
                inline static void call(std::int32_t first,
                                        GLsizei count,
                                        GLsizei primcount,
                                        std::uint32_t baseinstance) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawArraysInstancedBaseInstance " "mode: '" << ModeConstant::name()
                      << "'" ", " "first: '" << first << "'" ", " "count: '" << count << "'" ", " "primcount: '"
                      << primcount << "'" ", " "baseinstance: '" << baseinstance << "'";
            ...
            struct gl_draw_arrays_instanced_base_instance< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        GLsizei primcount,
                                        std::uint32_t baseinstance) {
                  __gtulu_debug() << "call glDrawArraysInstancedBaseInstance " "mode: '" << mode << "'" ", " "first: '"
                      << first << "'" ", " "count: '" << count << "'" ", " "primcount: '" << primcount
            ...
            struct gl_draw_elements_instanced_base_instance< C1, C2 > {
                inline static void call(GLsizei count,
                  ...
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawElementsInstancedBaseInstance " "mode: '" << ModeConstant::name()
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "indices: '" << indices << "'" ", " "primcount: '" << primcount
                      << "'" ", " "baseinstance: '" << baseinstance << "'";
                  glDrawElementsInstancedBaseInstance(ModeConstant::value,
                                                      count,
                                                      TypeConstant::value,
                                                      indices,
                                                      primcount,
            ...
            struct gl_draw_elements_instanced_base_instance< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        GLsizei primcount,
                                        std::uint32_t baseinstance) {
                  __gtulu_debug() << "call glDrawElementsInstancedBaseInstance " "mode: '" << mode
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << type << "'" ", " "indices: '" << indices
                      << "'" ", " "primcount: '" << primcount << "'" ", " "baseinstance: '" << baseinstance << "'";
                  glDrawElementsInstancedBaseInstance(std::uint32_t(mode),
                                                      count,
                                                      std::uint32_t(type),
                                                      indices,
                                                      primcount,
            ...
            struct gl_draw_elements_instanced_base_vertex_base_instance< C1, C2 > {
                inline static void call(GLsizei count,
                  ...
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawElementsInstancedBaseVertexBaseInstance " "mode: '"
                      << ModeConstant::name() << "'" ", " "count: '" << count << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "indices: '" << indices << "'" ", " "primcount: '"
                      << primcount << "'" ", " "basevertex: '" << basevertex << "'" ", " "baseinstance: '"
                      << baseinstance << "'";
                  glDrawElementsInstancedBaseVertexBaseInstance(ModeConstant::value,
                                                                count,
                                                                TypeConstant::value,
                                                                indices,
                                                                primcount,
            ...
            struct gl_draw_elements_instanced_base_vertex_base_instance< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        std::int32_t basevertex,
                                        std::uint32_t baseinstance) {
                  __gtulu_debug() << "call glDrawElementsInstancedBaseVertexBaseInstance " "mode: '" << mode
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << type << "'" ", " "indices: '" << indices
                      << "'" ", " "primcount: '" << primcount << "'" ", " "basevertex: '" << basevertex
                      << "'" ", " "baseinstance: '" << baseinstance << "'";
                  glDrawElementsInstancedBaseVertexBaseInstance(std::uint32_t(mode),
                                                                count,
                                                                std::uint32_t(type),
                                                                indices,
                                                                primcount,
        ...
        namespace blend_func_extended {
          namespace function {
            ...
            struct gl_bind_frag_data_location_indexed< > {
                inline static void call(std::uint32_t program,
                                        std::uint32_t colorNumber,
                                        std::uint32_t index,
                                        GLchar const* name) {
                  __gtulu_debug() << "call glBindFragDataLocationIndexed " "program: '" << program
                      << "'" ", " "colorNumber: '" << colorNumber << "'" ", " "index: '" << index << "'" ", " "name: '"
                      << name << "'";
          ...
          namespace function {
            ...
            struct gl_copy_buffer_sub_data< C1, C2 > {
                inline static void call(GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size) {
                  ...
                  __gtulu_debug() << "call glCopyBufferSubData " "readTarget: '" << ReadTargetConstant::name()
                      << "'" ", " "writeTarget: '" << WriteTargetConstant::name() << "'" ", " "readOffset: '"
                      << readOffset << "'" ", " "writeOffset: '" << writeOffset << "'" ", " "size: '" << size << "'";
                  glCopyBufferSubData(ReadTargetConstant::value,
                                      WriteTargetConstant::value,
                                      readOffset,
                                      writeOffset,
                                      size);
                  __gtulu_check_error();
            ...
            struct gl_copy_buffer_sub_data< > {
                inline static void call(cst::gl_constant_base const& readTarget,
                                        cst::gl_constant_base const& writeTarget,
                                        GLintptr readOffset,
                                        GLintptr writeOffset,
                                        GLsizeiptr size) {
                  __gtulu_debug() << "call glCopyBufferSubData " "readTarget: '" << readTarget
                      << "'" ", " "writeTarget: '" << writeTarget << "'" ", " "readOffset: '" << readOffset
                      << "'" ", " "writeOffset: '" << writeOffset << "'" ", " "size: '" << size << "'";
                  glCopyBufferSubData(std::uint32_t(readTarget),
                                      std::uint32_t(writeTarget),
                                      readOffset,
                                      writeOffset,
                                      size);
                  __gtulu_check_error();
          ...
          namespace function {
            ...
            struct gl_debug_message_callback< > {
                inline static void call(GLDEBUGPROCARB callback, void const* userParam) {
                  __gtulu_debug() << "call glDebugMessageCallbackARB " "callback: '" << callback
                      << "'" ", " "userParam: '" << userParam << "'";
            ...
            struct gl_debug_message_control< C1, C2, C3 > {
                inline static void call(GLsizei count, std::uint32_t const* ids, bool enabled) {
                  ...
                  __gtulu_debug() << "call glDebugMessageControlARB " "source: '" << SourceConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "severity: '"
                      << SeverityConstant::name() << "'" ", " "count: '" << count << "'" ", " "ids: '" << ids
                      << "'" ", " "enabled: '" << enabled << "'";
                  glDebugMessageControlARB(SourceConstant::value,
                                           TypeConstant::value,
                                           SeverityConstant::value,
                                           count,
                                           ids,
                                           (enabled ? 1 : 0));
                  __gtulu_check_error();
            ...
            struct gl_debug_message_control< > {
                inline static void call(cst::gl_constant_base const& source,
                                        cst::gl_constant_base const& type,
                                        cst::gl_constant_base const& severity,
                                        GLsizei count,
                                        std::uint32_t const* ids,
                                        bool enabled) {
                  __gtulu_debug() << "call glDebugMessageControlARB " "source: '" << source << "'" ", " "type: '"
                      << type << "'" ", " "severity: '" << severity << "'" ", " "count: '" << count << "'" ", " "ids: '"
                      << ids << "'" ", " "enabled: '" << enabled << "'";
                  glDebugMessageControlARB(std::uint32_t(source),
                                           std::uint32_t(type),
            ...
            struct gl_debug_message_insert< C1, C2, C3 > {
                inline static void call(std::uint32_t id, GLsizei length, GLchar const* buf) {
                  ...
                  typedef C2 TypeConstant;
                  typedef C3 SeverityConstant;
                  __gtulu_debug() << "call glDebugMessageInsertARB " "source: '" << SourceConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "id: '" << id << "'" ", " "severity: '"
                      << SeverityConstant::name() << "'" ", " "length: '" << length << "'" ", " "buf: '" << buf << "'";
                  glDebugMessageInsertARB(SourceConstant::value,
                                          TypeConstant::value,
                                          id,
                                          SeverityConstant::value,
                                          length,
            ...
            struct gl_debug_message_insert< > {
                inline static void call(cst::gl_constant_base const& source,
                                        ...
                                        GLsizei length,
                                        GLchar const* buf) {
                  __gtulu_debug() << "call glDebugMessageInsertARB " "source: '" << source << "'" ", " "type: '" << type
                      << "'" ", " "id: '" << id << "'" ", " "severity: '" << severity << "'" ", " "length: '" << length
                      << "'" ", " "buf: '" << buf << "'";
                  glDebugMessageInsertARB(std::uint32_t(source),
                                          std::uint32_t(type),
                                          id,
                                          std::uint32_t(severity),
                                          length,
            ...
            struct gl_get_debug_message_log< > {
                inline static GLuint call(std::uint32_t count,
                                          GLsizei bufsize,
                                          GLenum* sources,
                                          GLenum* types,
                                          std::uint32_t* ids,
                                          ...
                                          GLsizei* lengths,
                                          GLchar* messageLog) {
                  __gtulu_debug() << "call glGetDebugMessageLogARB " "count: '" << count << "'" ", " "bufsize: '"
                      << bufsize << "'" ", " "sources: '" << sources << "'" ", " "types: '" << types
                      << "'" ", " "ids: '" << ids << "'" ", " "severities: '" << severities << "'" ", " "lengths: '"
                      << lengths << "'" ", " "messageLog: '" << messageLog << "'";
                  GLuint out = glGetDebugMessageLogARB(count,
                                                       bufsize,
                                                       sources,
                                                       types,
                                                       ids,
          ...
          namespace function {
            ...
            struct gl_draw_elements_base_vertex< C1, C2 > {
                inline static void call(GLsizei count, void const* indices, std::int32_t basevertex) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawElementsBaseVertex " "mode: '" << ModeConstant::name()
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "indices: '" << indices << "'" ", " "basevertex: '" << basevertex << "'";
            ...
            struct gl_draw_elements_base_vertex< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        void const* indices,
                                        std::int32_t basevertex) {
                  __gtulu_debug() << "call glDrawElementsBaseVertex " "mode: '" << mode << "'" ", " "count: '" << count
                      << "'" ", " "type: '" << type << "'" ", " "indices: '" << indices << "'" ", " "basevertex: '"
                      << basevertex << "'";
            ...
            struct gl_draw_elements_instanced_base_vertex< C1, C2 > {
                inline static void call(GLsizei count,
                  ...
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawElementsInstancedBaseVertex " "mode: '" << ModeConstant::name()
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "indices: '" << indices << "'" ", " "primcount: '" << primcount
                      << "'" ", " "basevertex: '" << basevertex << "'";
                  glDrawElementsInstancedBaseVertex(ModeConstant::value,
                                                    count,
                                                    TypeConstant::value,
                                                    indices,
                                                    primcount,
            ...
            struct gl_draw_elements_instanced_base_vertex< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        GLsizei primcount,
                                        std::int32_t basevertex) {
                  __gtulu_debug() << "call glDrawElementsInstancedBaseVertex " "mode: '" << mode << "'" ", " "count: '"
                      << count << "'" ", " "type: '" << type << "'" ", " "indices: '" << indices
                      << "'" ", " "primcount: '" << primcount << "'" ", " "basevertex: '" << basevertex << "'";
                  glDrawElementsInstancedBaseVertex(std::uint32_t(mode),
                                                    count,
                                                    std::uint32_t(type),
                                                    indices,
                                                    primcount,
            ...
            struct gl_draw_range_elements_base_vertex< C1, C2 > {
                inline static void call(std::uint32_t start,
                                        std::uint32_t end,
                                        GLsizei count,
                                        void const* indices,
                                        std::int32_t basevertex) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawRangeElementsBaseVertex " "mode: '" << ModeConstant::name()
                      << "'" ", " "start: '" << start << "'" ", " "end: '" << end << "'" ", " "count: '" << count
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "indices: '" << indices
                      << "'" ", " "basevertex: '" << basevertex << "'";
                  glDrawRangeElementsBaseVertex(ModeConstant::value,
                                                start,
                                                end,
                                                count,
                                                TypeConstant::value,
            ...
            struct gl_draw_range_elements_base_vertex< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        void const* indices,
                                        std::int32_t basevertex) {
                  __gtulu_debug() << "call glDrawRangeElementsBaseVertex " "mode: '" << mode << "'" ", " "start: '"
                      << start << "'" ", " "end: '" << end << "'" ", " "count: '" << count << "'" ", " "type: '" << type
                      << "'" ", " "indices: '" << indices << "'" ", " "basevertex: '" << basevertex << "'";
                  glDrawRangeElementsBaseVertex(std::uint32_t(mode),
                                                start,
                                                end,
                                                count,
                                                std::uint32_t(type),
            ...
            struct gl_multi_draw_elements_base_vertex< C1, C2 > {
                inline static void call(GLsizei const* count,
                                        void const** indices,
                                        GLsizei primcount,
                                        std::int32_t const* basevertex) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiDrawElementsBaseVertex " "mode: '" << ModeConstant::name()
                      << "'" ", " "count: '" << count << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "indices: '" << indices << "'" ", " "primcount: '" << primcount
                      << "'" ", " "basevertex: '" << basevertex << "'";
                  glMultiDrawElementsBaseVertex(ModeConstant::value,
                                                count,
                                                TypeConstant::value,
                                                indices,
                                                primcount,
            ...
            struct gl_multi_draw_elements_base_vertex< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        GLsizei primcount,
                                        std::int32_t const* basevertex) {
                  __gtulu_debug() << "call glMultiDrawElementsBaseVertex " "mode: '" << mode << "'" ", " "count: '"
                      << count << "'" ", " "type: '" << type << "'" ", " "indices: '" << indices
                      << "'" ", " "primcount: '" << primcount << "'" ", " "basevertex: '" << basevertex << "'";
                  glMultiDrawElementsBaseVertex(std::uint32_t(mode),
                                                count,
                                                std::uint32_t(type),
                                                indices,
                                                primcount,
          ...
          namespace function {
            ...
            struct gl_draw_arrays_indirect< C1 > {
                inline static void call(void const* indirect) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawArraysIndirect " "mode: '" << ModeConstant::name()
                      << "'" ", " "indirect: '" << indirect << "'";
            ...
            struct gl_draw_arrays_indirect< > {
                inline static void call(cst::gl_constant_base const& mode, void const* indirect) {
                  __gtulu_debug() << "call glDrawArraysIndirect " "mode: '" << mode << "'" ", " "indirect: '"
                      << indirect << "'";
            ...
            struct gl_draw_elements_indirect< C1, C2 > {
                inline static void call(void const* indirect) {
                  typedef C1 ModeConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glDrawElementsIndirect " "mode: '" << ModeConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "indirect: '" << indirect << "'";
            ...
            struct gl_draw_elements_indirect< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        cst::gl_constant_base const& type,
                                        void const* indirect) {
                  __gtulu_debug() << "call glDrawElementsIndirect " "mode: '" << mode << "'" ", " "type: '" << type
                      << "'" ", " "indirect: '" << indirect << "'";
          ...
          namespace function {
            ...
            struct gl_bind_framebuffer< C1 > {
                inline static void call(std::uint32_t framebuffer) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBindFramebuffer " "target: '" << TargetConstant::name()
            ...
            struct gl_bind_framebuffer< > {
                inline static void call(cst::gl_constant_base const& target, std::uint32_t framebuffer) {
                  __gtulu_debug() << "call glBindFramebuffer " "target: '" << target << "'" ", " "framebuffer: '"
                      << framebuffer << "'";
            ...
            struct gl_bind_renderbuffer< C1 > {
                inline static void call(std::uint32_t renderbuffer) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBindRenderbuffer " "target: '" << TargetConstant::name()
            ...
            struct gl_bind_renderbuffer< > {
                inline static void call(cst::gl_constant_base const& target, std::uint32_t renderbuffer) {
                  __gtulu_debug() << "call glBindRenderbuffer " "target: '" << target << "'" ", " "renderbuffer: '"
                      << renderbuffer << "'";
            ...
            struct gl_blit_framebuffer< C1 > {
                inline static void call(std::int32_t srcX0,
                                        std::int32_t srcY0,
                                        std::int32_t srcX1,
                                        std::int32_t srcY1,
                                        std::int32_t dstX0,
                  ...
                  __gtulu_debug() << "call glBlitFramebuffer " "srcX0: '" << srcX0 << "'" ", " "srcY0: '" << srcY0
                      << "'" ", " "srcX1: '" << srcX1 << "'" ", " "srcY1: '" << srcY1 << "'" ", " "dstX0: '" << dstX0
                      << "'" ", " "dstY0: '" << dstY0 << "'" ", " "dstX1: '" << dstX1 << "'" ", " "dstY1: '" << dstY1
                      << "'" ", " "mask: '" << mask << "'" ", " "filter: '" << FilterConstant::name() << "'";
            ...
            struct gl_blit_framebuffer< > {
                inline static void call(std::int32_t srcX0,
                                        ...
                                        std::int32_t dstY1,
                                        GLbitfield mask,
                                        cst::gl_constant_base const& filter) {
                  __gtulu_debug() << "call glBlitFramebuffer " "srcX0: '" << srcX0 << "'" ", " "srcY0: '" << srcY0
                      << "'" ", " "srcX1: '" << srcX1 << "'" ", " "srcY1: '" << srcY1 << "'" ", " "dstX0: '" << dstX0
                      << "'" ", " "dstY0: '" << dstY0 << "'" ", " "dstX1: '" << dstX1 << "'" ", " "dstY1: '" << dstY1
            ...
            struct gl_delete_framebuffers< > {
                inline static void call(GLsizei n, std::uint32_t const* framebuffers) {
                  __gtulu_debug() << "call glDeleteFramebuffers " "n: '" << n << "'" ", " "framebuffers: '"
                      << framebuffers << "'";
            ...
            struct gl_delete_renderbuffers< > {
                inline static void call(GLsizei n, std::uint32_t const* renderbuffers) {
                  __gtulu_debug() << "call glDeleteRenderbuffers " "n: '" << n << "'" ", " "renderbuffers: '"
                      << renderbuffers << "'";
            ...
            struct gl_framebuffer_renderbuffer< C1, C2, C3 > {
                inline static void call(std::uint32_t renderbuffer) {
                  ...
                  __gtulu_debug() << "call glFramebufferRenderbuffer " "target: '" << TargetConstant::name()
                      << "'" ", " "attachment: '" << AttachmentConstant::name() << "'" ", " "renderbuffertarget: '"
                      << RenderbuffertargetConstant::name() << "'" ", " "renderbuffer: '" << renderbuffer << "'";
                  glFramebufferRenderbuffer(TargetConstant::value,
                                            AttachmentConstant::value,
                                            RenderbuffertargetConstant::value,
                                            renderbuffer);
                  __gtulu_check_error();
            ...
            struct gl_framebuffer_renderbuffer< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& attachment,
                                        cst::gl_constant_base const& renderbuffertarget,
                                        std::uint32_t renderbuffer) {
                  __gtulu_debug() << "call glFramebufferRenderbuffer " "target: '" << target << "'" ", " "attachment: '"
                      << attachment << "'" ", " "renderbuffertarget: '" << renderbuffertarget
                      << "'" ", " "renderbuffer: '" << renderbuffer << "'";
                  glFramebufferRenderbuffer(std::uint32_t(target),
                                            std::uint32_t(attachment),
                                            std::uint32_t(renderbuffertarget),
                                            renderbuffer);
                  __gtulu_check_error();
            ...
            struct gl_framebuffer_texture_1d< C1, C2, C3 > {
                inline static void call(std::uint32_t texture, std::int32_t level) {
                  ...
                  __gtulu_debug() << "call glFramebufferTexture1D " "target: '" << TargetConstant::name()
                      << "'" ", " "attachment: '" << AttachmentConstant::name() << "'" ", " "textarget: '"
                      << TextargetConstant::name() << "'" ", " "texture: '" << texture << "'" ", " "level: '" << level
                      << "'";
                  glFramebufferTexture1D(TargetConstant::value,
                                         AttachmentConstant::value,
                                         TextargetConstant::value,
                                         texture,
                                         level);
                  __gtulu_check_error();
            ...
            struct gl_framebuffer_texture_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& attachment,
                                        cst::gl_constant_base const& textarget,
                                        std::uint32_t texture,
                                        std::int32_t level) {
                  __gtulu_debug() << "call glFramebufferTexture1D " "target: '" << target << "'" ", " "attachment: '"
                      << attachment << "'" ", " "textarget: '" << textarget << "'" ", " "texture: '" << texture
                      << "'" ", " "level: '" << level << "'";
                  glFramebufferTexture1D(std::uint32_t(target),
                                         std::uint32_t(attachment),
                                         std::uint32_t(textarget),
                                         texture,
                                         level);
                  __gtulu_check_error();
            ...
            struct gl_framebuffer_texture_2d< C1, C2, C3 > {
                inline static void call(std::uint32_t texture, std::int32_t level) {
                  ...
                  typedef C2 AttachmentConstant;
                  typedef C3 TextargetConstant;
                  __gtulu_debug() << "call glFramebufferTexture2D " "target: '" << TargetConstant::name()
                      << "'" ", " "attachment: '" << AttachmentConstant::name() << "'" ", " "textarget: '"
                      << TextargetConstant::name() << "'" ", " "texture: '" << texture << "'" ", " "level: '" << level
                      << "'";
                  glFramebufferTexture2D(TargetConstant::value,
                                         AttachmentConstant::value,
                                         TextargetConstant::value,
                                         texture,
                                         level);
            ...
            struct gl_framebuffer_texture_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        std::uint32_t texture,
                                        std::int32_t level) {
                  __gtulu_debug() << "call glFramebufferTexture2D " "target: '" << target << "'" ", " "attachment: '"
                      << attachment << "'" ", " "textarget: '" << textarget << "'" ", " "texture: '" << texture
                      << "'" ", " "level: '" << level << "'";
                  glFramebufferTexture2D(std::uint32_t(target),
                                         std::uint32_t(attachment),
                                         std::uint32_t(textarget),
                                         texture,
                                         level);
            ...
            struct gl_framebuffer_texture_3d< C1, C2, C3 > {
                inline static void call(std::uint32_t texture, std::int32_t level, std::int32_t zoffset) {
                  ...
                  typedef C2 AttachmentConstant;
                  typedef C3 TextargetConstant;
                  __gtulu_debug() << "call glFramebufferTexture3D " "target: '" << TargetConstant::name()
                      << "'" ", " "attachment: '" << AttachmentConstant::name() << "'" ", " "textarget: '"
                      << TextargetConstant::name() << "'" ", " "texture: '" << texture << "'" ", " "level: '" << level
                      << "'" ", " "zoffset: '" << zoffset << "'";
                  glFramebufferTexture3D(TargetConstant::value,
                                         AttachmentConstant::value,
                                         TextargetConstant::value,
                                         texture,
                                         level,
            ...
            struct gl_framebuffer_texture_3d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        std::int32_t level,
                                        std::int32_t zoffset) {
                  __gtulu_debug() << "call glFramebufferTexture3D " "target: '" << target << "'" ", " "attachment: '"
                      << attachment << "'" ", " "textarget: '" << textarget << "'" ", " "texture: '" << texture
                      << "'" ", " "level: '" << level << "'" ", " "zoffset: '" << zoffset << "'";
                  glFramebufferTexture3D(std::uint32_t(target),
                                         std::uint32_t(attachment),
                                         std::uint32_t(textarget),
                                         texture,
                                         level,
            ...
            struct gl_framebuffer_texture_layer< C1, C2 > {
                inline static void call(std::uint32_t texture, std::int32_t level, std::int32_t layer) {
                  typedef C1 TargetConstant;
                  typedef C2 AttachmentConstant;
                  __gtulu_debug() << "call glFramebufferTextureLayer " "target: '" << TargetConstant::name()
                      << "'" ", " "attachment: '" << AttachmentConstant::name() << "'" ", " "texture: '" << texture
            ...
            struct gl_framebuffer_texture_layer< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        std::int32_t level,
                                        std::int32_t layer) {
                  __gtulu_debug() << "call glFramebufferTextureLayer " "target: '" << target << "'" ", " "attachment: '"
                      << attachment << "'" ", " "texture: '" << texture << "'" ", " "level: '" << level
                      << "'" ", " "layer: '" << layer << "'";
            ...
            struct gl_gen_renderbuffers< > {
                inline static void call(GLsizei n, std::uint32_t* renderbuffers) {
                  __gtulu_debug() << "call glGenRenderbuffers " "n: '" << n << "'" ", " "renderbuffers: '"
                      << renderbuffers << "'";
            ...
            struct gl_get_framebuffer_attachment_parameter< C1, C2, C3 > {
                inline static void call(std::int32_t* params) {
                  ...
                  __gtulu_debug() << "call glGetFramebufferAttachmentParameteriv " "target: '" << TargetConstant::name()
                      << "'" ", " "attachment: '" << AttachmentConstant::name() << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                  glGetFramebufferAttachmentParameteriv(TargetConstant::value,
                                                        AttachmentConstant::value,
                                                        PnameConstant::value,
                                                        params);
                  __gtulu_check_error();
            ...
            struct gl_get_framebuffer_attachment_parameter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetFramebufferAttachmentParameteriv " "target: '" << target
                      << "'" ", " "attachment: '" << attachment << "'" ", " "pname: '" << pname << "'" ", " "params: '"
                      << params << "'";
                  glGetFramebufferAttachmentParameteriv(std::uint32_t(target),
                                                        std::uint32_t(attachment),
                                                        std::uint32_t(pname),
                                                        params);
                  __gtulu_check_error();
            ...
            struct gl_get_renderbuffer_parameter< C1, C2 > {
                inline static void call(std::int32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetRenderbufferParameteriv " "target: '" << TargetConstant::name()
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_renderbuffer_parameter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetRenderbufferParameteriv " "target: '" << target << "'" ", " "pname: '"
                      << pname << "'" ", " "params: '" << params << "'";
            ...
            struct gl_renderbuffer_storage< C1, C2 > {
                inline static void call(GLsizei width, GLsizei height) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glRenderbufferStorage " "target: '" << TargetConstant::name()
                      << "'" ", " "internalformat: '" << InternalformatConstant::name() << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'";
            ...
            struct gl_renderbuffer_storage< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei width,
                                        GLsizei height) {
                  __gtulu_debug() << "call glRenderbufferStorage " "target: '" << target << "'" ", " "internalformat: '"
                      << internalformat << "'" ", " "width: '" << width << "'" ", " "height: '" << height << "'";
            ...
            struct gl_renderbuffer_storage_multisample< C1, C2 > {
                inline static void call(GLsizei samples, GLsizei width, GLsizei height) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glRenderbufferStorageMultisample " "target: '" << TargetConstant::name()
                      << "'" ", " "samples: '" << samples << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'";
                  glRenderbufferStorageMultisample(TargetConstant::value,
                                                   samples,
                                                   InternalformatConstant::value,
                                                   width,
                                                   height);
            ...
            struct gl_renderbuffer_storage_multisample< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei width,
                                        GLsizei height) {
                  __gtulu_debug() << "call glRenderbufferStorageMultisample " "target: '" << target
                      << "'" ", " "samples: '" << samples << "'" ", " "internalformat: '" << internalformat
                      << "'" ", " "width: '" << width << "'" ", " "height: '" << height << "'";
                  glRenderbufferStorageMultisample(std::uint32_t(target),
                                                   samples,
                                                   std::uint32_t(internalformat),
                                                   width,
                                                   height);
          ...
          namespace function {
            ...
            struct gl_get_program_binary< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLenum* binaryFormat,
                                        void* binary) {
                  __gtulu_debug() << "call glGetProgramBinary " "program: '" << program << "'" ", " "bufSize: '"
                      << bufSize << "'" ", " "length: '" << length << "'" ", " "binaryFormat: '" << binaryFormat
                      << "'" ", " "binary: '" << binary << "'";
            ...
            struct gl_program_binary< C1 > {
                inline static void call(std::uint32_t program, void const* binary, GLsizei length) {
                  typedef C1 BinaryFormatConstant;
                  __gtulu_debug() << "call glProgramBinary " "program: '" << program << "'" ", " "binaryFormat: '"
                      << BinaryFormatConstant::name() << "'" ", " "binary: '" << binary << "'" ", " "length: '"
                      << length << "'";
            ...
            struct gl_program_binary< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei length) {
                  __gtulu_debug() << "call glProgramBinary " "program: '" << program << "'" ", " "binaryFormat: '"
                      << binaryFormat << "'" ", " "binary: '" << binary << "'" ", " "length: '" << length << "'";
            ...
            struct gl_program_parameter< C1 > {
                inline static void call(std::uint32_t program, std::int32_t value) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glProgramParameteri " "program: '" << program << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_parameter< > {
                inline static void call(std::uint32_t program, cst::gl_constant_base const& pname, std::int32_t value) {
                  __gtulu_debug() << "call glProgramParameteri " "program: '" << program << "'" ", " "pname: '" << pname
                      << "'" ", " "value: '" << value << "'";
          ...
          namespace function {
            ...
            struct gl_get_internalformat< C1, C2, C3 > {
                inline static void call(GLsizei bufSize, std::int32_t* params) {
                  ...
                  typedef C2 InternalformatConstant;
                  typedef C3 PnameConstant;
                  __gtulu_debug() << "call glGetInternalformativ " "target: '" << TargetConstant::name()
                      << "'" ", " "internalformat: '" << InternalformatConstant::name() << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "bufSize: '" << bufSize << "'" ", " "params: '" << params
                      << "'";
                  glGetInternalformativ(TargetConstant::value,
                                        InternalformatConstant::value,
                                        PnameConstant::value,
                                        bufSize,
                                        params);
            ...
            struct gl_get_internalformat< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetInternalformativ " "target: '" << target << "'" ", " "internalformat: '"
                      << internalformat << "'" ", " "pname: '" << pname << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "params: '" << params << "'";
                  glGetInternalformativ(std::uint32_t(target),
                                        std::uint32_t(internalformat),
                                        std::uint32_t(pname),
                                        bufSize,
                                        params);
          ...
          namespace function {
            ...
            struct gl_flush_mapped_buffer_range< C1 > {
                inline static void call(GLintptr offset, GLsizeiptr length) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glFlushMappedBufferRange " "target: '" << TargetConstant::name()
            ...
            struct gl_flush_mapped_buffer_range< > {
                inline static void call(cst::gl_constant_base const& target, GLintptr offset, GLsizeiptr length) {
                  __gtulu_debug() << "call glFlushMappedBufferRange " "target: '" << target << "'" ", " "offset: '"
            ...
            struct gl_map_buffer_range< C1 > {
                inline static GLvoid* call(GLintptr offset, GLsizeiptr length, GLbitfield access) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glMapBufferRange " "target: '" << TargetConstant::name()
                      << "'" ", " "offset: '" << offset << "'" ", " "length: '" << length << "'" ", " "access: '"
                      << access << "'";
            ...
            struct gl_map_buffer_range< > {
                inline static GLvoid* call(cst::gl_constant_base const& target,
                                           GLintptr offset,
                                           GLsizeiptr length,
                                           GLbitfield access) {
                  __gtulu_debug() << "call glMapBufferRange " "target: '" << target << "'" ", " "offset: '" << offset
          ...
          namespace function {
            ...
            struct gl_get_n_color_table< C1, C2, C3 > {
                inline static void call(GLsizei bufSize, void* table) {
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glGetnColorTableARB " "target: '" << TargetConstant::name()
                      << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "table: '" << table << "'";
                  glGetnColorTableARB(TargetConstant::value,
                                      FormatConstant::value,
                                      TypeConstant::value,
                                      bufSize,
                                      table);
            ...
            struct gl_get_n_color_table< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        void* table) {
                  __gtulu_debug() << "call glGetnColorTableARB " "target: '" << target << "'" ", " "format: '" << format
                      << "'" ", " "type: '" << type << "'" ", " "bufSize: '" << bufSize << "'" ", " "table: '" << table
                      << "'";
                  glGetnColorTableARB(std::uint32_t(target),
                                      std::uint32_t(format),
                                      std::uint32_t(type),
                                      bufSize,
                                      table);
            ...
            struct gl_get_n_compressed_tex_image< C1 > {
                inline static void call(std::int32_t lod, GLsizei bufSize, void* img) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetnCompressedTexImageARB " "target: '" << TargetConstant::name()
                      << "'" ", " "lod: '" << lod << "'" ", " "bufSize: '" << bufSize << "'" ", " "img: '" << img
                      << "'";
            ...
            struct gl_get_n_compressed_tex_image< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        void* img) {
                  __gtulu_debug() << "call glGetnCompressedTexImageARB " "target: '" << target << "'" ", " "lod: '"
                      << lod << "'" ", " "bufSize: '" << bufSize << "'" ", " "img: '" << img << "'";
            ...
            struct gl_get_n_convolution_filter< C1, C2, C3 > {
                inline static void call(GLsizei bufSize, void* image) {
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glGetnConvolutionFilterARB " "target: '" << TargetConstant::name()
                      << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "image: '" << image << "'";
                  glGetnConvolutionFilterARB(TargetConstant::value,
                                             FormatConstant::value,
                                             TypeConstant::value,
                                             bufSize,
                                             image);
            ...
            struct gl_get_n_convolution_filter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        void* image) {
                  __gtulu_debug() << "call glGetnConvolutionFilterARB " "target: '" << target << "'" ", " "format: '"
                      << format << "'" ", " "type: '" << type << "'" ", " "bufSize: '" << bufSize << "'" ", " "image: '"
                      << image << "'";
                  glGetnConvolutionFilterARB(std::uint32_t(target),
                                             std::uint32_t(format),
                                             std::uint32_t(type),
                                             bufSize,
                                             image);
            ...
            struct gl_get_n_histogram< C1, C2, C3 > {
                inline static void call(bool reset, GLsizei bufSize, void* values) {
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glGetnHistogramARB " "target: '" << TargetConstant::name()
                      << "'" ", " "reset: '" << reset << "'" ", " "format: '" << FormatConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "values: '" << values << "'";
                  glGetnHistogramARB(TargetConstant::value,
                                     (reset ? 1 : 0),
                                     FormatConstant::value,
                                     TypeConstant::value,
                                     bufSize,
            ...
            struct gl_get_n_histogram< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        void* values) {
                  __gtulu_debug() << "call glGetnHistogramARB " "target: '" << target << "'" ", " "reset: '" << reset
                      << "'" ", " "format: '" << format << "'" ", " "type: '" << type << "'" ", " "bufSize: '"
                      << bufSize << "'" ", " "values: '" << values << "'";
                  glGetnHistogramARB(std::uint32_t(target),
                                     (reset ? 1 : 0),
                                     std::uint32_t(format),
                                     std::uint32_t(type),
                                     bufSize,
            ...
            struct gl_get_n_map< C1, C2 > {
                inline static void call(GLsizei bufSize, double* v) {
                  ...
                  __gtulu_debug() << "call glGetnMapdvARB " "target: '" << TargetConstant::name() << "'" ", " "query: '"
                      << QueryConstant::name() << "'" ", " "bufSize: '" << bufSize << "'" ", " "v: '" << v << "'";
                ...
                inline static void call(GLsizei bufSize, float* v) {
                  typedef C1 TargetConstant;
                  typedef C2 QueryConstant;
                  __gtulu_debug() << "call glGetnMapfvARB " "target: '" << TargetConstant::name() << "'" ", " "query: '"
                      << QueryConstant::name() << "'" ", " "bufSize: '" << bufSize << "'" ", " "v: '" << v << "'";
                ...
                inline static void call(GLsizei bufSize, std::int32_t* v) {
                  typedef C1 TargetConstant;
                  typedef C2 QueryConstant;
                  __gtulu_debug() << "call glGetnMapivARB " "target: '" << TargetConstant::name() << "'" ", " "query: '"
                      << QueryConstant::name() << "'" ", " "bufSize: '" << bufSize << "'" ", " "v: '" << v << "'";
            ...
            struct gl_get_n_map< > {
                inline static void call(cst::gl_constant_base const& target,
                                        cst::gl_constant_base const& query,
                                        GLsizei bufSize,
                                        double* v) {
                  __gtulu_debug() << "call glGetnMapdvARB " "target: '" << target << "'" ", " "query: '" << query
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "v: '" << v << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        float* v) {
                  __gtulu_debug() << "call glGetnMapfvARB " "target: '" << target << "'" ", " "query: '" << query
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "v: '" << v << "'";
                ...
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        std::int32_t* v) {
                  __gtulu_debug() << "call glGetnMapivARB " "target: '" << target << "'" ", " "query: '" << query
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "v: '" << v << "'";
            ...
            struct gl_get_n_minmax< C1, C2, C3 > {
                inline static void call(bool reset, GLsizei bufSize, void* values) {
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glGetnMinmaxARB " "target: '" << TargetConstant::name()
                      << "'" ", " "reset: '" << reset << "'" ", " "format: '" << FormatConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "values: '" << values << "'";
                  glGetnMinmaxARB(TargetConstant::value,
                                  (reset ? 1 : 0),
                                  FormatConstant::value,
                                  TypeConstant::value,
                                  bufSize,
            ...
            struct gl_get_n_minmax< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        void* values) {
                  __gtulu_debug() << "call glGetnMinmaxARB " "target: '" << target << "'" ", " "reset: '" << reset
                      << "'" ", " "format: '" << format << "'" ", " "type: '" << type << "'" ", " "bufSize: '"
                      << bufSize << "'" ", " "values: '" << values << "'";
                  glGetnMinmaxARB(std::uint32_t(target),
                                  (reset ? 1 : 0),
                                  std::uint32_t(format),
                                  std::uint32_t(type),
                                  bufSize,
            ...
            struct gl_get_n_pixel_map< C1 > {
                inline static void call(GLsizei bufSize, float* values) {
                  ...
                  __gtulu_debug() << "call glGetnPixelMapfvARB " "map: '" << MapConstant::name()
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "values: '" << values << "'";
                ...
                inline static void call(GLsizei bufSize, std::uint32_t* values) {
                  typedef C1 MapConstant;
                  __gtulu_debug() << "call glGetnPixelMapuivARB " "map: '" << MapConstant::name()
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "values: '" << values << "'";
                ...
                inline static void call(GLsizei bufSize, std::uint16_t* values) {
                  typedef C1 MapConstant;
                  __gtulu_debug() << "call glGetnPixelMapusvARB " "map: '" << MapConstant::name()
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "values: '" << values << "'";
            ...
            struct gl_get_n_pixel_map< > {
                inline static void call(cst::gl_constant_base const& map, GLsizei bufSize, float* values) {
                  __gtulu_debug() << "call glGetnPixelMapfvARB " "map: '" << map << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "values: '" << values << "'";
                ...
                inline static void call(cst::gl_constant_base const& map, GLsizei bufSize, std::uint32_t* values) {
                  __gtulu_debug() << "call glGetnPixelMapuivARB " "map: '" << map << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "values: '" << values << "'";
                ...
                inline static void call(cst::gl_constant_base const& map, GLsizei bufSize, std::uint16_t* values) {
                  __gtulu_debug() << "call glGetnPixelMapusvARB " "map: '" << map << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "values: '" << values << "'";
            ...
            struct gl_get_n_polygon_stipple< > {
                inline static void call(GLsizei bufSize, std::uint8_t* pattern) {
                  __gtulu_debug() << "call glGetnPolygonStippleARB " "bufSize: '" << bufSize << "'" ", " "pattern: '"
                      << pattern << "'";
            ...
            struct gl_get_n_separable_filter< C1, C2, C3 > {
                inline static void call(GLsizei rowBufSize,
                                        void* row,
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glGetnSeparableFilterARB " "target: '" << TargetConstant::name()
                      << "'" ", " "format: '" << FormatConstant::name() << "'" ", " "type: '" << TypeConstant::name()
                      << "'" ", " "rowBufSize: '" << rowBufSize << "'" ", " "row: '" << row
                      << "'" ", " "columnBufSize: '" << columnBufSize << "'" ", " "column: '" << column
                      << "'" ", " "span: '" << span << "'";
                  glGetnSeparableFilterARB(TargetConstant::value,
                                           FormatConstant::value,
                                           TypeConstant::value,
                                           rowBufSize,
                                           row,
            ...
            struct gl_get_n_separable_filter< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        void* column,
                                        void* span) {
                  __gtulu_debug() << "call glGetnSeparableFilterARB " "target: '" << target << "'" ", " "format: '"
                      << format << "'" ", " "type: '" << type << "'" ", " "rowBufSize: '" << rowBufSize
                      << "'" ", " "row: '" << row << "'" ", " "columnBufSize: '" << columnBufSize
                      << "'" ", " "column: '" << column << "'" ", " "span: '" << span << "'";
                  glGetnSeparableFilterARB(std::uint32_t(target),
                                           std::uint32_t(format),
                                           std::uint32_t(type),
                                           rowBufSize,
                                           row,
            ...
            struct gl_get_n_tex_image< C1, C2, C3 > {
                inline static void call(std::int32_t level, GLsizei bufSize, void* img) {
                  ...
                  typedef C2 FormatConstant;
                  typedef C3 TypeConstant;
                  __gtulu_debug() << "call glGetnTexImageARB " "target: '" << TargetConstant::name()
                      << "'" ", " "level: '" << level << "'" ", " "format: '" << FormatConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "img: '" << img << "'";
                  glGetnTexImageARB(TargetConstant::value,
                                    level,
                                    FormatConstant::value,
                                    TypeConstant::value,
                                    bufSize,
            ...
            struct gl_get_n_tex_image< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei bufSize,
                                        void* img) {
                  __gtulu_debug() << "call glGetnTexImageARB " "target: '" << target << "'" ", " "level: '" << level
                      << "'" ", " "format: '" << format << "'" ", " "type: '" << type << "'" ", " "bufSize: '"
                      << bufSize << "'" ", " "img: '" << img << "'";
                  glGetnTexImageARB(std::uint32_t(target),
                                    level,
                                    std::uint32_t(format),
                                    std::uint32_t(type),
                                    bufSize,
            ...
            struct gl_get_n_uniform< > {
                inline static void call(std::uint32_t program, std::int32_t location, GLsizei bufSize, float* params) {
                  __gtulu_debug() << "call glGetnUniformfvARB " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "bufSize: '" << bufSize << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei bufSize,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetnUniformivARB " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "bufSize: '" << bufSize << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei bufSize,
                                        std::uint32_t* params) {
                  __gtulu_debug() << "call glGetnUniformuivARB " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "bufSize: '" << bufSize << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, GLsizei bufSize, double* params) {
                  __gtulu_debug() << "call glGetnUniformdvARB " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "bufSize: '" << bufSize << "'" ", " "params: '" << params << "'";
            ...
            struct gl_read_n_pixels< C1, C2 > {
                inline static void call(std::int32_t x,
                  ...
                  typedef C1 FormatConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glReadnPixelsARB " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'" ", " "format: '" << FormatConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "data: '" << data << "'";
            ...
            struct gl_read_n_pixels< > {
                inline static void call(std::int32_t x,
                  ...
                  __gtulu_debug() << "call glReadnPixelsARB " "x: '" << x << "'" ", " "y: '" << y << "'" ", " "width: '"
                      << width << "'" ", " "height: '" << height << "'" ", " "format: '" << format << "'" ", " "type: '"
                      << type << "'" ", " "bufSize: '" << bufSize << "'" ", " "data: '" << data << "'";
          ...
          namespace function {
            ...
            struct gl_get_sampler_parameter< C1 > {
                inline static void call(std::uint32_t sampler, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetSamplerParameteriv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t sampler, float* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetSamplerParameterfv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_sampler_parameter< > {
                inline static void call(std::uint32_t sampler,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetSamplerParameteriv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << pname << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_sampler_parameter_integer< C1 > {
                inline static void call(std::uint32_t sampler, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetSamplerParameterIiv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
                ...
                inline static void call(std::uint32_t sampler, std::uint32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetSamplerParameterIuiv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_sampler_parameter< C1 > {
                inline static void call(std::uint32_t sampler, std::int32_t param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glSamplerParameteri " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(std::uint32_t sampler, std::int32_t const* param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glSamplerParameteriv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(std::uint32_t sampler, float param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glSamplerParameterf " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(std::uint32_t sampler, float const* param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glSamplerParameterfv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "param: '" << param << "'";
            ...
            struct gl_sampler_parameter< > {
                inline static void call(std::uint32_t sampler, cst::gl_constant_base const& pname, std::int32_t param) {
                  __gtulu_debug() << "call glSamplerParameteri " "sampler: '" << sampler << "'" ", " "pname: '" << pname
                      << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(std::uint32_t sampler, cst::gl_constant_base const& pname, float param) {
                  __gtulu_debug() << "call glSamplerParameterf " "sampler: '" << sampler << "'" ", " "pname: '" << pname
                      << "'" ", " "param: '" << param << "'";
            ...
            struct gl_sampler_parameter_integer< C1 > {
                inline static void call(std::uint32_t sampler, std::int32_t const* param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glSamplerParameterIiv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "param: '" << param << "'";
                ...
                inline static void call(std::uint32_t sampler, std::uint32_t const* param) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glSamplerParameterIuiv " "sampler: '" << sampler << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "param: '" << param << "'";
          ...
          namespace function {
            ...
            struct gl_active_shader_program< > {
                inline static void call(std::uint32_t pipeline, std::uint32_t program) {
                  __gtulu_debug() << "call glActiveShaderProgram " "pipeline: '" << pipeline << "'" ", " "program: '"
                      << program << "'";
            ...
            struct gl_create_shader_program< C1 > {
                inline static GLuint call(GLsizei count, GLchar const** strings) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glCreateShaderProgramv " "type: '" << TypeConstant::name()
                      << "'" ", " "count: '" << count << "'" ", " "strings: '" << strings << "'";
            ...
            struct gl_create_shader_program< > {
                inline static GLuint call(cst::gl_constant_base const& type, GLsizei count, GLchar const** strings) {
                  __gtulu_debug() << "call glCreateShaderProgramv " "type: '" << type << "'" ", " "count: '" << count
                      << "'" ", " "strings: '" << strings << "'";
            ...
            struct gl_delete_program_pipelines< > {
                inline static void call(GLsizei n, std::uint32_t const* pipelines) {
                  __gtulu_debug() << "call glDeleteProgramPipelines " "n: '" << n << "'" ", " "pipelines: '"
                      << pipelines << "'";
            ...
            struct gl_get_program_pipeline< C1 > {
                inline static void call(std::uint32_t pipeline, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetProgramPipelineiv " "pipeline: '" << pipeline << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_program_pipeline_info_log< > {
                inline static void call(std::uint32_t pipeline, GLsizei bufSize, GLsizei* length, GLchar* infoLog) {
                  __gtulu_debug() << "call glGetProgramPipelineInfoLog " "pipeline: '" << pipeline
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "length: '" << length << "'" ", " "infoLog: '"
                      << infoLog << "'";
            ...
            struct gl_program_uniform_1< > {
                inline static void call(std::uint32_t program, std::int32_t location, std::int32_t v0) {
                  __gtulu_debug() << "call glProgramUniform1i " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::int32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform1iv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, float v0) {
                  __gtulu_debug() << "call glProgramUniform1f " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniform1fv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, double v0) {
                  __gtulu_debug() << "call glProgramUniform1d " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniform1dv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, std::uint32_t v0) {
                  __gtulu_debug() << "call glProgramUniform1ui " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform1uiv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_2< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::int32_t v0,
                                        std::int32_t v1) {
                  __gtulu_debug() << "call glProgramUniform2i " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::int32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform2iv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, float v0, float v1) {
                  __gtulu_debug() << "call glProgramUniform2f " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniform2fv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, double v0, double v1) {
                  __gtulu_debug() << "call glProgramUniform2d " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniform2dv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        std::uint32_t v0,
                                        std::uint32_t v1) {
                  __gtulu_debug() << "call glProgramUniform2ui " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform2uiv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_3< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::int32_t v1,
                                        std::int32_t v2) {
                  __gtulu_debug() << "call glProgramUniform3i " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::int32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform3iv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, float v0, float v1, float v2) {
                  __gtulu_debug() << "call glProgramUniform3f " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniform3fv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program, std::int32_t location, double v0, double v1, double v2) {
                  __gtulu_debug() << "call glProgramUniform3d " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniform3dv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        std::uint32_t v1,
                                        std::uint32_t v2) {
                  __gtulu_debug() << "call glProgramUniform3ui " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform3uiv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_4< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::int32_t v2,
                                        std::int32_t v3) {
                  __gtulu_debug() << "call glProgramUniform4i " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2
                      << "'" ", " "v3: '" << v3 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::int32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform4iv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        float v2,
                                        float v3) {
                  __gtulu_debug() << "call glProgramUniform4f " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2
                      << "'" ", " "v3: '" << v3 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniform4fv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        double v2,
                                        double v3) {
                  __gtulu_debug() << "call glProgramUniform4d " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2
                      << "'" ", " "v3: '" << v3 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniform4dv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        std::uint32_t v2,
                                        std::uint32_t v3) {
                  __gtulu_debug() << "call glProgramUniform4ui " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "v0: '" << v0 << "'" ", " "v1: '" << v1 << "'" ", " "v2: '" << v2
                      << "'" ", " "v3: '" << v3 << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei count,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glProgramUniform4uiv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_2< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix2fv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "transpose: '" << transpose
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix2dv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "transpose: '" << transpose
                      << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_2x3< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix2x3fv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix2x3dv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_2x4< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix2x4fv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix2x4dv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_3< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix3fv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "transpose: '" << transpose
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix3dv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "transpose: '" << transpose
                      << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_3x2< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix3x2fv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix3x2dv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_3x4< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix3x4fv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix3x4dv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_4< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix4fv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "transpose: '" << transpose
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix4dv " "program: '" << program << "'" ", " "location: '"
                      << location << "'" ", " "count: '" << count << "'" ", " "transpose: '" << transpose
                      << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_4x2< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix4x2fv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix4x2dv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_program_uniform_matrix_4x3< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        float const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix4x3fv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t program,
                                        ...
                                        bool transpose,
                                        double const* value) {
                  __gtulu_debug() << "call glProgramUniformMatrix4x3dv " "program: '" << program
                      << "'" ", " "location: '" << location << "'" ", " "count: '" << count << "'" ", " "transpose: '"
                      << transpose << "'" ", " "value: '" << value << "'";
            ...
            struct gl_use_program_stages< > {
                inline static void call(std::uint32_t pipeline, GLbitfield stages, std::uint32_t program) {
                  __gtulu_debug() << "call glUseProgramStages " "pipeline: '" << pipeline << "'" ", " "stages: '"
          ...
          namespace function {
            ...
            struct gl_get_active_atomic_counter_buffer< C1 > {
                inline static void call(std::uint32_t program, std::uint32_t bufferIndex, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetActiveAtomicCounterBufferiv " "program: '" << program
                      << "'" ", " "bufferIndex: '" << bufferIndex << "'" ", " "pname: '" << PnameConstant::name()
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_active_atomic_counter_buffer< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetActiveAtomicCounterBufferiv " "program: '" << program
                      << "'" ", " "bufferIndex: '" << bufferIndex << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
        ...
        namespace shader_image_load_store {
          namespace function {
            ...
            struct gl_bind_image_texture< C1, C2 > {
                inline static void call(std::uint32_t unit,
                                        std::uint32_t texture,
                                        std::int32_t level,
                                        bool layered,
                                        std::int32_t layer) {
                  ...
                  typedef C2 FormatConstant;
                  __gtulu_debug() << "call glBindImageTexture " "unit: '" << unit << "'" ", " "texture: '" << texture
                      << "'" ", " "level: '" << level << "'" ", " "layered: '" << layered << "'" ", " "layer: '"
                      << layer << "'" ", " "access: '" << AccessConstant::name() << "'" ", " "format: '"
                      << FormatConstant::name() << "'";
            ...
            struct gl_bind_image_texture< > {
                inline static void call(std::uint32_t unit,
                                        ...
                                        bool layered,
                                        std::int32_t layer,
                                        cst::gl_constant_base const& access,
                                        cst::gl_constant_base const& format) {
                  __gtulu_debug() << "call glBindImageTexture " "unit: '" << unit << "'" ", " "texture: '" << texture
                      << "'" ", " "level: '" << level << "'" ", " "layered: '" << layered << "'" ", " "layer: '"
                      << layer << "'" ", " "access: '" << access << "'" ", " "format: '" << format << "'";
                  glBindImageTexture(unit,
                                     texture,
                                     level,
                                     (layered ? 1 : 0),
          ...
          namespace function {
            ...
            struct gl_get_active_subroutine_name< C1 > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLchar* name) {
                  typedef C1 ShadertypeConstant;
                  __gtulu_debug() << "call glGetActiveSubroutineName " "program: '" << program
                      << "'" ", " "shadertype: '" << ShadertypeConstant::name() << "'" ", " "index: '" << index
                      << "'" ", " "bufsize: '" << bufsize << "'" ", " "length: '" << length << "'" ", " "name: '"
                      << name << "'";
            ...
            struct gl_get_active_subroutine_name< > {
                inline static void call(std::uint32_t program,
                                        cst::gl_constant_base const& shadertype,
                                        std::uint32_t index,
                                        GLsizei bufsize,
                                        GLsizei* length,
                                        GLchar* name) {
                  __gtulu_debug() << "call glGetActiveSubroutineName " "program: '" << program
                      << "'" ", " "shadertype: '" << shadertype << "'" ", " "index: '" << index << "'" ", " "bufsize: '"
                      << bufsize << "'" ", " "length: '" << length << "'" ", " "name: '" << name << "'";
            ...
            struct gl_get_active_subroutine_uniform< C1, C2 > {
                inline static void call(std::uint32_t program, std::uint32_t index, std::int32_t* values) {
                  typedef C1 ShadertypeConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetActiveSubroutineUniformiv " "program: '" << program
                      << "'" ", " "shadertype: '" << ShadertypeConstant::name() << "'" ", " "index: '" << index
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "values: '" << values << "'";
                  glGetActiveSubroutineUniformiv(program,
                                                 ShadertypeConstant::value,
                                                 index,
                                                 PnameConstant::value,
                                                 values);
                  __gtulu_check_error();
            ...
            struct gl_get_active_subroutine_uniform< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::int32_t* values) {
                  __gtulu_debug() << "call glGetActiveSubroutineUniformiv " "program: '" << program
                      << "'" ", " "shadertype: '" << shadertype << "'" ", " "index: '" << index << "'" ", " "pname: '"
                      << pname << "'" ", " "values: '" << values << "'";
                  glGetActiveSubroutineUniformiv(program,
            ...
            struct gl_get_active_subroutine_uniform_name< C1 > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLchar* name) {
                  typedef C1 ShadertypeConstant;
                  __gtulu_debug() << "call glGetActiveSubroutineUniformName " "program: '" << program
                      << "'" ", " "shadertype: '" << ShadertypeConstant::name() << "'" ", " "index: '" << index
                      << "'" ", " "bufsize: '" << bufsize << "'" ", " "length: '" << length << "'" ", " "name: '"
                      << name << "'";
            ...
            struct gl_get_program_stage< C1, C2 > {
                inline static void call(std::uint32_t program, std::int32_t* values) {
                  typedef C1 ShadertypeConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetProgramStageiv " "program: '" << program << "'" ", " "shadertype: '"
                      << ShadertypeConstant::name() << "'" ", " "pname: '" << PnameConstant::name()
                      << "'" ", " "values: '" << values << "'";
            ...
            struct gl_get_program_stage< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::int32_t* values) {
                  __gtulu_debug() << "call glGetProgramStageiv " "program: '" << program << "'" ", " "shadertype: '"
                      << shadertype << "'" ", " "pname: '" << pname << "'" ", " "values: '" << values << "'";
            ...
            struct gl_get_subroutine_index< C1 > {
                inline static GLuint call(std::uint32_t program, GLchar const* name) {
                  typedef C1 ShadertypeConstant;
                  __gtulu_debug() << "call glGetSubroutineIndex " "program: '" << program << "'" ", " "shadertype: '"
                      << ShadertypeConstant::name() << "'" ", " "name: '" << name << "'";
            ...
            struct gl_get_subroutine_index< > {
                inline static GLuint call(std::uint32_t program,
                                          cst::gl_constant_base const& shadertype,
                                          GLchar const* name) {
                  __gtulu_debug() << "call glGetSubroutineIndex " "program: '" << program << "'" ", " "shadertype: '"
                      << shadertype << "'" ", " "name: '" << name << "'";
            ...
            struct gl_get_subroutine_uniform_location< C1 > {
                inline static GLint call(std::uint32_t program, GLchar const* name) {
                  typedef C1 ShadertypeConstant;
                  __gtulu_debug() << "call glGetSubroutineUniformLocation " "program: '" << program
                      << "'" ", " "shadertype: '" << ShadertypeConstant::name() << "'" ", " "name: '" << name << "'";
            ...
            struct gl_get_subroutine_uniform_location< > {
                inline static GLint call(std::uint32_t program,
                                         cst::gl_constant_base const& shadertype,
                                         GLchar const* name) {
                  __gtulu_debug() << "call glGetSubroutineUniformLocation " "program: '" << program
                      << "'" ", " "shadertype: '" << shadertype << "'" ", " "name: '" << name << "'";
            ...
            struct gl_get_uniform_subroutine< C1 > {
                inline static void call(std::int32_t location, std::uint32_t* params) {
                  typedef C1 ShadertypeConstant;
                  __gtulu_debug() << "call glGetUniformSubroutineuiv " "shadertype: '" << ShadertypeConstant::name()
            ...
            struct gl_get_uniform_subroutine< > {
                inline static void call(cst::gl_constant_base const& shadertype,
                                        std::int32_t location,
                                        std::uint32_t* params) {
                  __gtulu_debug() << "call glGetUniformSubroutineuiv " "shadertype: '" << shadertype
                      << "'" ", " "location: '" << location << "'" ", " "params: '" << params << "'";
            ...
            struct gl_uniform_subroutines< C1 > {
                inline static void call(GLsizei count, std::uint32_t const* indices) {
                  typedef C1 ShadertypeConstant;
                  __gtulu_debug() << "call glUniformSubroutinesuiv " "shadertype: '" << ShadertypeConstant::name()
            ...
            struct gl_uniform_subroutines< > {
                inline static void call(cst::gl_constant_base const& shadertype,
                  ...
                  __gtulu_debug() << "call glUniformSubroutinesuiv " "shadertype: '" << shadertype
                      << "'" ", " "count: '" << count << "'" ", " "indices: '" << indices << "'";
          ...
          namespace function {
            ...
            struct gl_compile_shader_include< > {
                inline static void call(std::uint32_t shader,
                                        ...
                                        GLchar const** path,
                                        std::int32_t const* length) {
                  __gtulu_debug() << "call glCompileShaderIncludeARB " "shader: '" << shader << "'" ", " "count: '"
                      << count << "'" ", " "path: '" << path << "'" ", " "length: '" << length << "'";
            ...
            struct gl_delete_named_string< > {
                inline static void call(std::int32_t namelen, GLchar const* name) {
                  __gtulu_debug() << "call glDeleteNamedStringARB " "namelen: '" << namelen << "'" ", " "name: '"
                      << name << "'";
            ...
            struct gl_get_named_string< C1 > {
                inline static void call(std::int32_t namelen, GLchar const* name, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetNamedStringivARB " "namelen: '" << namelen << "'" ", " "name: '" << name
                      << "'" ", " "pname: '" << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_named_string< > {
                inline static void call(std::int32_t namelen,
                                        GLchar const* name,
                                        GLsizei bufSize,
                                        std::int32_t* stringlen,
                                        GLchar* string) {
                  __gtulu_debug() << "call glGetNamedStringARB " "namelen: '" << namelen << "'" ", " "name: '" << name
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "stringlen: '" << stringlen
                      << "'" ", " "string: '" << string << "'";
            ...
            struct gl_named_string< C1 > {
                inline static void call(std::int32_t namelen,
                                        ...
                                        GLchar const* string) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glNamedStringARB " "type: '" << TypeConstant::name() << "'" ", " "namelen: '"
                      << namelen << "'" ", " "name: '" << name << "'" ", " "stringlen: '" << stringlen
                      << "'" ", " "string: '" << string << "'";
            ...
            struct gl_named_string< > {
                inline static void call(cst::gl_constant_base const& type,
                                        std::int32_t namelen,
                                        GLchar const* name,
                                        std::int32_t stringlen,
                                        GLchar const* string) {
                  __gtulu_debug() << "call glNamedStringARB " "type: '" << type << "'" ", " "namelen: '" << namelen
                      << "'" ", " "name: '" << name << "'" ", " "stringlen: '" << stringlen << "'" ", " "string: '"
                      << string << "'";
          ...
          namespace function {
            ...
            struct gl_client_wait_sync< > {
                inline static GLenum call(GLsync sync, GLbitfield flags, GLuint64 timeout) {
                  __gtulu_debug() << "call glClientWaitSync " "sync: '" << sync << "'" ", " "flags: '" << flags
                      << "'" ", " "timeout: '" << timeout << "'";
            ...
            struct gl_fence_sync< C1 > {
                inline static GLsync call(GLbitfield flags) {
                  ...
                  __gtulu_debug() << "call glFenceSync " "condition: '" << ConditionConstant::name()
                      << "'" ", " "flags: '" << flags << "'";
            ...
            struct gl_get_sync< C1 > {
                inline static void call(GLsync sync, GLsizei bufSize, GLsizei* length, std::int32_t* values) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetSynciv " "sync: '" << sync << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "bufSize: '" << bufSize << "'" ", " "length: '" << length
                      << "'" ", " "values: '" << values << "'";
            ...
            struct gl_get_sync< > {
                inline static void call(GLsync sync,
                                        ...
                                        GLsizei* length,
                                        std::int32_t* values) {
                  __gtulu_debug() << "call glGetSynciv " "sync: '" << sync << "'" ", " "pname: '" << pname
                      << "'" ", " "bufSize: '" << bufSize << "'" ", " "length: '" << length << "'" ", " "values: '"
                      << values << "'";
            ...
            struct gl_wait_sync< > {
                inline static void call(GLsync sync, GLbitfield flags, GLuint64 timeout) {
                  __gtulu_debug() << "call glWaitSync " "sync: '" << sync << "'" ", " "flags: '" << flags
                      << "'" ", " "timeout: '" << timeout << "'";
          ...
          namespace function {
            ...
            struct gl_patch_parameter< C1 > {
                inline static void call(std::int32_t value) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPatchParameteri " "pname: '" << PnameConstant::name()
                      << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(float const* values) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glPatchParameterfv " "pname: '" << PnameConstant::name()
                      << "'" ", " "values: '" << values << "'";
          ...
          namespace function {
            ...
            struct gl_get_multisample< C1 > {
                inline static void call(std::uint32_t index, float* val) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetMultisamplefv " "pname: '" << PnameConstant::name()
                      << "'" ", " "index: '" << index << "'" ", " "val: '" << val << "'";
            ...
            struct gl_get_multisample< > {
                inline static void call(cst::gl_constant_base const& pname, std::uint32_t index, float* val) {
                  __gtulu_debug() << "call glGetMultisamplefv " "pname: '" << pname << "'" ", " "index: '" << index
                      << "'" ", " "val: '" << val << "'";
            ...
            struct gl_tex_image_2d_multisample< C1, C2 > {
                inline static void call(GLsizei samples, GLsizei width, GLsizei height, bool fixedsamplelocations) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTexImage2DMultisample " "target: '" << TargetConstant::name()
                      << "'" ", " "samples: '" << samples << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'" ", " "fixedsamplelocations: '" << fixedsamplelocations << "'";
                  glTexImage2DMultisample(TargetConstant::value,
                                          samples,
                                          InternalformatConstant::value,
                                          width,
                                          height,
                                          (fixedsamplelocations ? 1 : 0));
                  __gtulu_check_error();
            ...
            struct gl_tex_image_2d_multisample< > {
                inline static void call(cst::gl_constant_base const& target,
                  ...
                  __gtulu_debug() << "call glTexImage2DMultisample " "target: '" << target << "'" ", " "samples: '"
                      << samples << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "fixedsamplelocations: '" << fixedsamplelocations
                      << "'";
                  glTexImage2DMultisample(std::uint32_t(target),
                                          samples,
                                          std::uint32_t(internalformat),
                                          width,
                                          height,
            ...
            struct gl_tex_image_3d_multisample< C1, C2 > {
                inline static void call(GLsizei samples,
                                        GLsizei width,
                                        GLsizei height,
                                        GLsizei depth,
                                        bool fixedsamplelocations) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTexImage3DMultisample " "target: '" << TargetConstant::name()
                      << "'" ", " "samples: '" << samples << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'" ", " "depth: '" << depth << "'" ", " "fixedsamplelocations: '"
                      << fixedsamplelocations << "'";
                  glTexImage3DMultisample(TargetConstant::value,
                                          samples,
                                          InternalformatConstant::value,
                                          width,
                                          height,
            ...
            struct gl_tex_image_3d_multisample< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei depth,
                                        bool fixedsamplelocations) {
                  __gtulu_debug() << "call glTexImage3DMultisample " "target: '" << target << "'" ", " "samples: '"
                      << samples << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth
                      << "'" ", " "fixedsamplelocations: '" << fixedsamplelocations << "'";
                  glTexImage3DMultisample(std::uint32_t(target),
                                          samples,
                                          std::uint32_t(internalformat),
                                          width,
                                          height,
          ...
          namespace function {
            ...
            struct gl_tex_storage_1d< C1, C2 > {
                inline static void call(GLsizei levels, GLsizei width) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTexStorage1D " "target: '" << TargetConstant::name()
                      << "'" ", " "levels: '" << levels << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'";
            ...
            struct gl_tex_storage_1d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& internalformat,
                                        GLsizei width) {
                  __gtulu_debug() << "call glTexStorage1D " "target: '" << target << "'" ", " "levels: '" << levels
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width << "'";
            ...
            struct gl_tex_storage_2d< C1, C2 > {
                inline static void call(GLsizei levels, GLsizei width, GLsizei height) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTexStorage2D " "target: '" << TargetConstant::name()
                      << "'" ", " "levels: '" << levels << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'";
            ...
            struct gl_tex_storage_2d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei width,
                                        GLsizei height) {
                  __gtulu_debug() << "call glTexStorage2D " "target: '" << target << "'" ", " "levels: '" << levels
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'";
            ...
            struct gl_tex_storage_3d< C1, C2 > {
                inline static void call(GLsizei levels, GLsizei width, GLsizei height, GLsizei depth) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTexStorage3D " "target: '" << TargetConstant::name()
                      << "'" ", " "levels: '" << levels << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'" ", " "depth: '" << depth << "'";
            ...
            struct gl_tex_storage_3d< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        GLsizei height,
                                        GLsizei depth) {
                  __gtulu_debug() << "call glTexStorage3D " "target: '" << target << "'" ", " "levels: '" << levels
                      << "'" ", " "internalformat: '" << internalformat << "'" ", " "width: '" << width
                      << "'" ", " "height: '" << height << "'" ", " "depth: '" << depth << "'";
            ...
            struct gl_texture_storage_1d< C1, C2 > {
                inline static void call(std::uint32_t texture, GLsizei levels, GLsizei width) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTextureStorage1DEXT " "texture: '" << texture << "'" ", " "target: '"
                      << TargetConstant::name() << "'" ", " "levels: '" << levels << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'";
            ...
            struct gl_texture_storage_1d< > {
                inline static void call(std::uint32_t texture,
                                        cst::gl_constant_base const& target,
                                        GLsizei levels,
                                        cst::gl_constant_base const& internalformat,
                                        GLsizei width) {
                  __gtulu_debug() << "call glTextureStorage1DEXT " "texture: '" << texture << "'" ", " "target: '"
                      << target << "'" ", " "levels: '" << levels << "'" ", " "internalformat: '" << internalformat
                      << "'" ", " "width: '" << width << "'";
            ...
            struct gl_texture_storage_2d< C1, C2 > {
                inline static void call(std::uint32_t texture, GLsizei levels, GLsizei width, GLsizei height) {
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTextureStorage2DEXT " "texture: '" << texture << "'" ", " "target: '"
                      << TargetConstant::name() << "'" ", " "levels: '" << levels << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'";
            ...
            struct gl_texture_storage_3d< C1, C2 > {
                inline static void call(std::uint32_t texture,
                  ...
                  typedef C1 TargetConstant;
                  typedef C2 InternalformatConstant;
                  __gtulu_debug() << "call glTextureStorage3DEXT " "texture: '" << texture << "'" ", " "target: '"
                      << TargetConstant::name() << "'" ", " "levels: '" << levels << "'" ", " "internalformat: '"
                      << InternalformatConstant::name() << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'" ", " "depth: '" << depth << "'";
        ...
        namespace timer_query {
          namespace function {
            ...
            struct gl_query_counter< C1 > {
                inline static void call(std::uint32_t id) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glQueryCounter " "id: '" << id << "'" ", " "target: '"
                      << TargetConstant::name() << "'";
        ...
        namespace transform_feedback2 {
          namespace function {
            ...
            struct gl_bind_transform_feedback< C1 > {
                inline static void call(std::uint32_t id) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBindTransformFeedback " "target: '" << TargetConstant::name()
                      << "'" ", " "id: '" << id << "'";
            ...
            struct gl_draw_transform_feedback< C1 > {
                inline static void call(std::uint32_t id) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawTransformFeedback " "mode: '" << ModeConstant::name()
                      << "'" ", " "id: '" << id << "'";
          ...
          namespace function {
            ...
            struct gl_begin_query_indexed< C1 > {
                inline static void call(std::uint32_t index, std::uint32_t id) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glBeginQueryIndexed " "target: '" << TargetConstant::name()
                      << "'" ", " "index: '" << index << "'" ", " "id: '" << id << "'";
            ...
            struct gl_begin_query_indexed< > {
                inline static void call(cst::gl_constant_base const& target, std::uint32_t index, std::uint32_t id) {
                  __gtulu_debug() << "call glBeginQueryIndexed " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "id: '" << id << "'";
            ...
            struct gl_draw_transform_feedback_stream< C1 > {
                inline static void call(std::uint32_t id, std::uint32_t stream) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawTransformFeedbackStream " "mode: '" << ModeConstant::name()
                      << "'" ", " "id: '" << id << "'" ", " "stream: '" << stream << "'";
            ...
            struct gl_draw_transform_feedback_stream< > {
                inline static void call(cst::gl_constant_base const& mode, std::uint32_t id, std::uint32_t stream) {
                  __gtulu_debug() << "call glDrawTransformFeedbackStream " "mode: '" << mode << "'" ", " "id: '" << id
                      << "'" ", " "stream: '" << stream << "'";
            ...
            struct gl_end_query_indexed< C1 > {
                inline static void call(std::uint32_t index) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glEndQueryIndexed " "target: '" << TargetConstant::name()
                      << "'" ", " "index: '" << index << "'";
            ...
            struct gl_get_query_indexed< C1, C2 > {
                inline static void call(std::uint32_t index, std::int32_t* params) {
                  typedef C1 TargetConstant;
                  typedef C2 PnameConstant;
                  __gtulu_debug() << "call glGetQueryIndexediv " "target: '" << TargetConstant::name()
                      << "'" ", " "index: '" << index << "'" ", " "pname: '" << PnameConstant::name()
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_query_indexed< > {
                inline static void call(cst::gl_constant_base const& target,
                                        ...
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetQueryIndexediv " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "pname: '" << pname << "'" ", " "params: '" << params << "'";
          ...
          namespace function {
            ...
            struct gl_draw_transform_feedback_instanced< C1 > {
                inline static void call(std::uint32_t id, GLsizei primcount) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawTransformFeedbackInstanced " "mode: '" << ModeConstant::name()
                      << "'" ", " "id: '" << id << "'" ", " "primcount: '" << primcount << "'";
            ...
            struct gl_draw_transform_feedback_instanced< > {
                inline static void call(cst::gl_constant_base const& mode, std::uint32_t id, GLsizei primcount) {
                  __gtulu_debug() << "call glDrawTransformFeedbackInstanced " "mode: '" << mode << "'" ", " "id: '"
                      << id << "'" ", " "primcount: '" << primcount << "'";
            ...
            struct gl_draw_transform_feedback_stream_instanced< C1 > {
                inline static void call(std::uint32_t id, std::uint32_t stream, GLsizei primcount) {
                  typedef C1 ModeConstant;
                  __gtulu_debug() << "call glDrawTransformFeedbackStreamInstanced " "mode: '" << ModeConstant::name()
                      << "'" ", " "id: '" << id << "'" ", " "stream: '" << stream << "'" ", " "primcount: '"
                      << primcount << "'";
            ...
            struct gl_draw_transform_feedback_stream_instanced< > {
                inline static void call(cst::gl_constant_base const& mode,
                                        ...
                                        std::uint32_t stream,
                                        GLsizei primcount) {
                  __gtulu_debug() << "call glDrawTransformFeedbackStreamInstanced " "mode: '" << mode
                      << "'" ", " "id: '" << id << "'" ", " "stream: '" << stream << "'" ", " "primcount: '"
                      << primcount << "'";
          ...
          namespace function {
            ...
            struct gl_get_active_uniform_block< C1 > {
                inline static void call(std::uint32_t program, std::uint32_t uniformBlockIndex, std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetActiveUniformBlockiv " "program: '" << program
                      << "'" ", " "uniformBlockIndex: '" << uniformBlockIndex << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_active_uniform_block< > {
                inline static void call(std::uint32_t program,
                                        std::uint32_t uniformBlockIndex,
                                        cst::gl_constant_base const& pname,
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetActiveUniformBlockiv " "program: '" << program
                      << "'" ", " "uniformBlockIndex: '" << uniformBlockIndex << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_active_uniform_block_name< > {
                inline static void call(std::uint32_t program,
                  ...
                  __gtulu_debug() << "call glGetActiveUniformBlockName " "program: '" << program
                      << "'" ", " "uniformBlockIndex: '" << uniformBlockIndex << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "length: '" << length << "'" ", " "uniformBlockName: '" << uniformBlockName << "'";
            ...
            struct gl_get_active_uniform_name< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        GLsizei* length,
                                        GLchar* uniformName) {
                  __gtulu_debug() << "call glGetActiveUniformName " "program: '" << program
                      << "'" ", " "uniformIndex: '" << uniformIndex << "'" ", " "bufSize: '" << bufSize
                      << "'" ", " "length: '" << length << "'" ", " "uniformName: '" << uniformName << "'";
            ...
            struct gl_get_active_uniforms< C1 > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::uint32_t const* uniformIndices,
                                        std::int32_t* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetActiveUniformsiv " "program: '" << program << "'" ", " "uniformCount: '"
                      << uniformCount << "'" ", " "uniformIndices: '" << uniformIndices << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_active_uniforms< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::int32_t* params) {
                  __gtulu_debug() << "call glGetActiveUniformsiv " "program: '" << program << "'" ", " "uniformCount: '"
                      << uniformCount << "'" ", " "uniformIndices: '" << uniformIndices << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_uniform_block_index< > {
                inline static GLuint call(std::uint32_t program, GLchar const* uniformBlockName) {
                  __gtulu_debug() << "call glGetUniformBlockIndex " "program: '" << program
            ...
            struct gl_get_uniform_indices< > {
                inline static void call(std::uint32_t program,
                                        ...
                                        std::uint32_t* uniformIndices) {
                  __gtulu_debug() << "call glGetUniformIndices " "program: '" << program << "'" ", " "uniformCount: '"
                      << uniformCount << "'" ", " "uniformNames: '" << uniformNames << "'" ", " "uniformIndices: '"
                      << uniformIndices << "'";
            ...
            struct gl_uniform_block_binding< > {
                inline static void call(std::uint32_t program,
                                        std::uint32_t uniformBlockIndex,
                                        std::uint32_t uniformBlockBinding) {
                  __gtulu_debug() << "call glUniformBlockBinding " "program: '" << program
                      << "'" ", " "uniformBlockIndex: '" << uniformBlockIndex << "'" ", " "uniformBlockBinding: '"
                      << uniformBlockBinding << "'";
        ...
        namespace vertex_attrib_64bit {
          namespace function {
            ...
            struct gl_get_vertex_attrib_large< C1 > {
                inline static void call(std::uint32_t index, double* params) {
                  typedef C1 PnameConstant;
                  __gtulu_debug() << "call glGetVertexAttribLdv " "index: '" << index << "'" ", " "pname: '"
                      << PnameConstant::name() << "'" ", " "params: '" << params << "'";
            ...
            struct gl_get_vertex_attrib_large< > {
                inline static void call(std::uint32_t index, cst::gl_constant_base const& pname, double* params) {
                  __gtulu_debug() << "call glGetVertexAttribLdv " "index: '" << index << "'" ", " "pname: '" << pname
                      << "'" ", " "params: '" << params << "'";
            ...
            struct gl_vertex_attrib_2_large< > {
                inline static void call(std::uint32_t index, double x, double y) {
                  __gtulu_debug() << "call glVertexAttribL2d " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'";
            ...
            struct gl_vertex_attrib_3_large< > {
                inline static void call(std::uint32_t index, double x, double y, double z) {
                  __gtulu_debug() << "call glVertexAttribL3d " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'";
            ...
            struct gl_vertex_attrib_4_large< > {
                inline static void call(std::uint32_t index, double x, double y, double z, double w) {
                  __gtulu_debug() << "call glVertexAttribL4d " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "z: '" << z << "'" ", " "w: '" << w << "'";
            ...
            struct gl_vertex_attrib_pointer_large_integer< C1 > {
                inline static void call(std::uint32_t index, std::int32_t size, GLsizei stride, void const* pointer) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribLPointer " "index: '" << index << "'" ", " "size: '" << size
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "stride: '" << stride
                      << "'" ", " "pointer: '" << pointer << "'";
          ...
          namespace function {
            ...
            struct gl_color_3_packed< C1 > {
                inline static void call(std::uint32_t color) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glColorP3ui " "type: '" << TypeConstant::name() << "'" ", " "color: '"
                      << color << "'";
                ...
                inline static void call(std::uint32_t const* color) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glColorP3uiv " "type: '" << TypeConstant::name() << "'" ", " "color: '"
                      << color << "'";
            ...
            struct gl_color_4_packed< C1 > {
                inline static void call(std::uint32_t color) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glColorP4ui " "type: '" << TypeConstant::name() << "'" ", " "color: '"
                      << color << "'";
                ...
                inline static void call(std::uint32_t const* color) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glColorP4uiv " "type: '" << TypeConstant::name() << "'" ", " "color: '"
                      << color << "'";
            ...
            struct gl_multi_tex_coord_1_packed< C1, C2 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP1ui " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP1uiv " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_multi_tex_coord_1_packed< > {
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t coords) {
                  __gtulu_debug() << "call glMultiTexCoordP1ui " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t const* coords) {
                  __gtulu_debug() << "call glMultiTexCoordP1uiv " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_multi_tex_coord_2_packed< C1, C2 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP2ui " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP2uiv " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_multi_tex_coord_2_packed< > {
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t coords) {
                  __gtulu_debug() << "call glMultiTexCoordP2ui " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t const* coords) {
                  __gtulu_debug() << "call glMultiTexCoordP2uiv " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_multi_tex_coord_3_packed< C1, C2 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP3ui " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP3uiv " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_multi_tex_coord_3_packed< > {
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t coords) {
                  __gtulu_debug() << "call glMultiTexCoordP3ui " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t const* coords) {
                  __gtulu_debug() << "call glMultiTexCoordP3uiv " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_multi_tex_coord_4_packed< C1, C2 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP4ui " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TextureConstant;
                  typedef C2 TypeConstant;
                  __gtulu_debug() << "call glMultiTexCoordP4uiv " "texture: '" << TextureConstant::name()
                      << "'" ", " "type: '" << TypeConstant::name() << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_multi_tex_coord_4_packed< > {
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t coords) {
                  __gtulu_debug() << "call glMultiTexCoordP4ui " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
                ...
                inline static void call(cst::gl_constant_base const& texture,
                                        cst::gl_constant_base const& type,
                                        std::uint32_t const* coords) {
                  __gtulu_debug() << "call glMultiTexCoordP4uiv " "texture: '" << texture << "'" ", " "type: '" << type
                      << "'" ", " "coords: '" << coords << "'";
            ...
            struct gl_normal_3_packed< C1 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glNormalP3ui " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glNormalP3uiv " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
            ...
            struct gl_secondary_color_3_packed< C1 > {
                inline static void call(std::uint32_t color) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glSecondaryColorP3ui " "type: '" << TypeConstant::name()
                      << "'" ", " "color: '" << color << "'";
                ...
                inline static void call(std::uint32_t const* color) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glSecondaryColorP3uiv " "type: '" << TypeConstant::name()
                      << "'" ", " "color: '" << color << "'";
            ...
            struct gl_tex_coord_1_packed< C1 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP1ui " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP1uiv " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
            ...
            struct gl_tex_coord_2_packed< C1 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP2ui " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP2uiv " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
            ...
            struct gl_tex_coord_3_packed< C1 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP3ui " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP3uiv " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
            ...
            struct gl_tex_coord_4_packed< C1 > {
                inline static void call(std::uint32_t coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP4ui " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
                ...
                inline static void call(std::uint32_t const* coords) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glTexCoordP4uiv " "type: '" << TypeConstant::name() << "'" ", " "coords: '"
                      << coords << "'";
            ...
            struct gl_vertex_2_packed< C1 > {
                inline static void call(std::uint32_t value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexP2ui " "type: '" << TypeConstant::name() << "'" ", " "value: '"
                      << value << "'";
                ...
                inline static void call(std::uint32_t const* value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexP2uiv " "type: '" << TypeConstant::name() << "'" ", " "value: '"
                      << value << "'";
            ...
            struct gl_vertex_3_packed< C1 > {
                inline static void call(std::uint32_t value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexP3ui " "type: '" << TypeConstant::name() << "'" ", " "value: '"
                      << value << "'";
                ...
                inline static void call(std::uint32_t const* value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexP3uiv " "type: '" << TypeConstant::name() << "'" ", " "value: '"
                      << value << "'";
            ...
            struct gl_vertex_4_packed< C1 > {
                inline static void call(std::uint32_t value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexP4ui " "type: '" << TypeConstant::name() << "'" ", " "value: '"
                      << value << "'";
                ...
                inline static void call(std::uint32_t const* value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexP4uiv " "type: '" << TypeConstant::name() << "'" ", " "value: '"
                      << value << "'";
            ...
            struct gl_vertex_attrib_1_packed< C1 > {
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP1ui " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
                ...
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t const* value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP1uiv " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
            ...
            struct gl_vertex_attrib_1_packed< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t value) {
                  __gtulu_debug() << "call glVertexAttribP1ui " "index: '" << index << "'" ", " "type: '" << type
                ...
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glVertexAttribP1uiv " "index: '" << index << "'" ", " "type: '" << type
                      << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value << "'";
            ...
            struct gl_vertex_attrib_2_packed< C1 > {
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP2ui " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
                ...
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t const* value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP2uiv " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
            ...
            struct gl_vertex_attrib_2_packed< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t value) {
                  __gtulu_debug() << "call glVertexAttribP2ui " "index: '" << index << "'" ", " "type: '" << type
                      << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glVertexAttribP2uiv " "index: '" << index << "'" ", " "type: '" << type
                      << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value << "'";
            ...
            struct gl_vertex_attrib_3_packed< C1 > {
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP3ui " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
                ...
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t const* value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP3uiv " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
            ...
            struct gl_vertex_attrib_3_packed< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t value) {
                  __gtulu_debug() << "call glVertexAttribP3ui " "index: '" << index << "'" ", " "type: '" << type
                      << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glVertexAttribP3uiv " "index: '" << index << "'" ", " "type: '" << type
                      << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value << "'";
            ...
            struct gl_vertex_attrib_4_packed< C1 > {
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP4ui " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
                ...
                inline static void call(std::uint32_t index, bool normalized, std::uint32_t const* value) {
                  typedef C1 TypeConstant;
                  __gtulu_debug() << "call glVertexAttribP4uiv " "index: '" << index << "'" ", " "type: '"
                      << TypeConstant::name() << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value
                      << "'";
            ...
            struct gl_vertex_attrib_4_packed< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t value) {
                  __gtulu_debug() << "call glVertexAttribP4ui " "index: '" << index << "'" ", " "type: '" << type
                      << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value << "'";
                ...
                inline static void call(std::uint32_t index,
                                        ...
                                        bool normalized,
                                        std::uint32_t const* value) {
                  __gtulu_debug() << "call glVertexAttribP4uiv " "index: '" << index << "'" ", " "type: '" << type
                      << "'" ", " "normalized: '" << normalized << "'" ", " "value: '" << value << "'";
          ...
          namespace function {
            ...
            struct gl_depth_range_array< > {
                inline static void call(std::uint32_t first, GLsizei count, GLclampd const* v) {
                  __gtulu_debug() << "call glDepthRangeArrayv " "first: '" << first << "'" ", " "count: '" << count
                      << "'" ", " "v: '" << v << "'";
            ...
            struct gl_depth_range_indexed< > {
                inline static void call(std::uint32_t index, GLclampd n, GLclampd f) {
                  __gtulu_debug() << "call glDepthRangeIndexed " "index: '" << index << "'" ", " "n: '" << n
                      << "'" ", " "f: '" << f << "'";
            ...
            struct gl_get_double_indexed< C1 > {
                inline static void call(std::uint32_t index, double* data) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetDoublei_v " "target: '" << TargetConstant::name() << "'" ", " "index: '"
                      << index << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_double_indexed< > {
                inline static void call(cst::gl_constant_base const& target, std::uint32_t index, double* data) {
                  __gtulu_debug() << "call glGetDoublei_v " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_float_indexed< C1 > {
                inline static void call(std::uint32_t index, float* data) {
                  typedef C1 TargetConstant;
                  __gtulu_debug() << "call glGetFloati_v " "target: '" << TargetConstant::name() << "'" ", " "index: '"
                      << index << "'" ", " "data: '" << data << "'";
            ...
            struct gl_get_float_indexed< > {
                inline static void call(cst::gl_constant_base const& target, std::uint32_t index, float* data) {
                  __gtulu_debug() << "call glGetFloati_v " "target: '" << target << "'" ", " "index: '" << index
                      << "'" ", " "data: '" << data << "'";
            ...
            struct gl_scissor_array< > {
                inline static void call(std::uint32_t first, GLsizei count, std::int32_t const* v) {
                  __gtulu_debug() << "call glScissorArrayv " "first: '" << first << "'" ", " "count: '" << count
                      << "'" ", " "v: '" << v << "'";
            ...
            struct gl_scissor_indexed< > {
                inline static void call(std::uint32_t index,
                                        ...
                                        GLsizei width,
                                        GLsizei height) {
                  __gtulu_debug() << "call glScissorIndexed " "index: '" << index << "'" ", " "left: '" << left
                      << "'" ", " "bottom: '" << bottom << "'" ", " "width: '" << width << "'" ", " "height: '"
                      << height << "'";
            ...
            struct gl_viewport_array< > {
                inline static void call(std::uint32_t first, GLsizei count, float const* v) {
                  __gtulu_debug() << "call glViewportArrayv " "first: '" << first << "'" ", " "count: '" << count
                      << "'" ", " "v: '" << v << "'";
            ...
            struct gl_viewport_indexed< > {
                inline static void call(std::uint32_t index, float x, float y, float w, float h) {
                  __gtulu_debug() << "call glViewportIndexedf " "index: '" << index << "'" ", " "x: '" << x
                      << "'" ", " "y: '" << y << "'" ", " "w: '" << w << "'" ", " "h: '" << h << "'";
