  ...
  namespace internal {
    ...
    namespace framebuffer {
      ...
      struct texture_attacher_detail {
          template< typename temporary_framebuffer_slot_t >
...
#define DECLARE_ATTACHER(layered_m, target_format_m, attach_function_m) \
      ...
      struct texture_attacher_detail< gif::layered::layered_m, ft::target_format_m > { \
          ...
          inline static void attach(const ::boost::uint32_t color, const gio::texture_base& texture, \
                                    const ::boost::uint32_t mipmap_level, const ::boost::uint32_t layer) { \
            __gl_debug(attach_function_m, (temporary_framebuffer_slot_t())(color)(*texture)(mipmap_level)); \
            attach_function_m(gif::slots::from_type< temporary_framebuffer_slot_t >::value, color, *texture, mipmap_level); \
            __gl_check_error; \
          } \
      }; \
...
#define DECLARE_ATTACHER_TARGET(layered_m, target_format_m, attach_function_m) \
      ...
      struct texture_attacher_detail< gif::layered::layered_m, ftf::target_format_m > { \
          ...
          inline static void attach(const ::boost::uint32_t color, const gio::texture_base& texture, \
                                    const ::boost::uint32_t mipmap_level, const ::boost::uint32_t layer) { \
            __gl_debug(attach_function_m, (temporary_framebuffer_slot_t())(color)(typename ftf::target_format_m())(*texture)(mipmap_level)); \
            attach_function_m(gif::slots::from_type< temporary_framebuffer_slot_t >::value, color, ftf::from_type< typename ftf::target_format_m >::value, *texture, mipmap_level); \
            __gl_check_error; \
          } \
      }; \
...
#define DECLARE_ATTACHER_CUBE(target_format_m) \
      ...
      struct texture_attacher_detail< gif::layered::no, ftf::target_format_m > { \
          ...
          inline static void attach(const ::boost::uint32_t color, const gio::texture_base& texture, \
                                    const ::boost::uint32_t mipmap_level, const ::boost::uint32_t layer) { \
            __gl_debug(glFramebufferTexture2D, (temporary_framebuffer_slot_t())(color)(typename ftf::target_format_m())(*texture)(mipmap_level)); \
            glFramebufferTexture2D(gif::slots::from_type< temporary_framebuffer_slot_t >::value, color, ftf::from_type< typename ftf::target_format_m >::value, *texture, mipmap_level); \
            __gl_check_error; \
          } \
      }; \
      ...
      struct texture_attacher_detail< gif::layered::no, ftf::gl_texture_3d > {
          ...
          inline static void attach(const ::boost::uint32_t color, const gio::texture_base& texture,
                                    const ::boost::uint32_t mipmap_level, const ::boost::uint32_t layer) {
            __gl_debug(glFramebufferTexture3D, (temporary_framebuffer_slot_t())(color)(typename ftf::gl_texture_3d())(*texture)(mipmap_level)(layer));
            glFramebufferTexture3D(gif::slots::from_type< temporary_framebuffer_slot_t >::value, color, ftf::from_type<
...
#undef DECLARE_ATTACHER
      ...
      struct texture_attacher: public is_target_attachable< typename texture_format_t::target, target_format_t > {
          ...
          inline static void attach(const ::boost::uint32_t color, const gio::texture< texture_format_t >& texture,
                                    const ::boost::uint32_t mipmap_level, const ::boost::uint32_t layer) {
            texture_attacher_detail< layered_t, target_format_t >::template attach< temporary_framebuffer_slot_t >(
      ...
      struct attacher {
          ...
          inline static void attach(const ::boost::uint32_t color, const gio::texture< texture_format_t >& texture,
                                    const ::boost::uint32_t mipmap_level, const ::boost::uint32_t layer) {
            texture_attacher< layered_t, texture_format_t, target_format_t >::template attach<
                temporary_framebuffer_slot_t >(color, texture, mipmap_level, layer);
          }

          inline static void attach(const ::boost::uint32_t color, const gio::renderbuffer_base& renderbuffer,
                                    const ::boost::uint32_t mipmap_level, const ::boost::uint32_t layer) {
            __gl_debug(glFramebufferRenderbuffer, (temporary_framebuffer_slot_t())(color)(typename ft::gl_renderbuffer::info::format())(*renderbuffer));
            glFramebufferRenderbuffer(gif::slots::from_type< temporary_framebuffer_slot_t >::value, color,
                ftf::from_type< ft::gl_renderbuffer::info::format >::value, *renderbuffer);
            __gl_check_error; \
          }
      };
    } // namespace framebuffer
