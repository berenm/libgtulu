  ...
  namespace internal {
    ...
    namespace format {
      namespace common {
        ...
        META_ASPECT_DECLARE(normalization,
                            Normalization,
                            struct,
                            (none)
                            (normalized)
        ...
        META_ASPECT_DECLARE(compression,
                            Compression,
                            struct,
                            (none)
                            (compressed)
