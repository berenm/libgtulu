    ...
    namespace formats {
      namespace texture {
        ...
        struct dimension_check {
            ...
            typedef typename bm::or_< ftt::is_twod< target_format_t >, ftt::is_rectangle< target_format_t > >::type
                is_twod_t;
        ...
        template< typename target_t, typename internal_t, typename group_t, typename data_t, typename value_t >
        struct loader< target_t, internal_t, group_t, data_t, value_t, typename ::boost::enable_if<
            typename dimension_check< target_t >::is_oned_t >::type, typename ::boost::enable_if<
            typename compression_check< target_t >::is_not_compressed_t >::type > {
        ...
        template< typename target_t, typename internal_t, typename group_t, typename data_t, typename value_t >
        struct loader< target_t, internal_t, group_t, data_t, value_t, typename ::boost::enable_if<
            typename dimension_check< target_t >::is_twod_t >::type, typename ::boost::enable_if<
            typename compression_check< target_t >::is_not_compressed_t >::type > {
            inline static void load(value_t const* data,
                                    ::std::size_t const data_size,
                                    ::std::size_t const width,
        ...
        template< typename target_t, typename internal_t, typename group_t, typename data_t, typename value_t >
        struct loader< target_t, internal_t, group_t, data_t, value_t, typename ::boost::enable_if<
            typename dimension_check< target_t >::is_threed_t >::type, typename ::boost::enable_if<
            typename compression_check< target_t >::is_not_compressed_t >::type > {
            inline static void load(value_t const* data,
                                    ::std::size_t const data_size,
                                    ::std::size_t const width,
        ...
        struct loader< target_t, internal_t, group_t, data_t, value_t, typename ::boost::enable_if<
            typename dimension_check< target_t >::is_oned_t >::type, typename ::boost::enable_if<
            typename compression_check< target_t >::is_compressed_t >::type > {
            inline static void load(value_t const* data,
                                    ::std::size_t const data_size,
                                    ::std::size_t const width,
                                    ::std::uint32_t const level,
                                    ::std::uint8_t const border) {
              fnc::gl_compressed_tex_image_1d::call< target_t, internal_t, group_t, data_t >(level,
                                                                                             width,
                                                                                             border,
                                                                                             data_size,
                                                                                             data);
            ...
            inline static void load(value_t const* data,
                                    ...
                                    ::std::size_t const width,
                                    ::std::uint32_t const level) {
              fnc::gl_compressed_tex_sub_image_1d::call< target_t, group_t, data_t >(level,
                                                                                     xoffset,
                                                                                     width,
                                                                                     data_size,
                                                                                     data);
        ...
        struct loader< target_t, internal_t, group_t, data_t, value_t, typename ::boost::enable_if<
            ...
            inline static void load(value_t const* data,
                                    ...
                                    ::std::uint32_t const level,
                                    ::std::uint8_t const border) {
              fnc::gl_compressed_tex_image_2d::call< target_t, internal_t, group_t, data_t >(level,
                                                                                             width,
                                                                                             height,
                                                                                             border,
                                                                                             data_size,
            ...
            inline static void load(value_t const* data,
                                    ...
                                    ::std::size_t const height,
                                    ::std::uint32_t const level) {
              fnc::gl_compressed_tex_sub_image_2d::call< target_t, group_t, data_t >(level,
                                                                                     xoffset,
                                                                                     yoffset,
                                                                                     width,
                                                                                     height,
        ...
        template< typename target_t, typename internal_t, typename group_t, typename data_t, typename value_t >
        struct loader< target_t, internal_t, group_t, data_t, value_t, typename ::boost::enable_if<
            typename dimension_check< target_t >::is_three_t >::type, typename ::boost::enable_if<
            typename compression_check< target_t >::is_compressed_t >::type > {
            inline static void load(value_t const* data,
                                    ::std::size_t const data_size,
                                    ::std::size_t const width,
                                    ...
                                    ::std::uint32_t const level,
                                    ::std::uint8_t const border) {
              fnc::gl_compressed_tex_image_3d::call< target_t, internal_t, group_t, data_t >(level,
                                                                                             width,
                                                                                             height,
                                                                                             depth,
                                                                                             border,
            ...
            inline static void load(value_t const* data,
                                    ...
                                    ::std::size_t const depth,
                                    ::std::uint32_t const level) {
              fnc::gl_compressed_tex_sub_image_3d::call< target_t, group_t, data_t >(level,
                                                                                     xoffset,
                                                                                     yoffset,
                                                                                     zoffset,
                                                                                     width,
        ...
        struct texture_format: fg::is_internal_compatible< group_format_t, internal_format_t >,
            ...
            typedef typename texture_loader< texture_format< target_format_t, internal_format_t, group_format_t,
                data_format_t > >::type loader;
        };
