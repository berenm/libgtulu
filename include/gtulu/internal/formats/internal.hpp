  ...
  namespace internal {
    ...
    namespace formats {
      namespace internal {
        ...
        META_ASPECT_DECLARE(base, Base, struct, (depth) (stencil) (depth_stencil) (r) (rg) (rgb) (rgba))
        META_ASPECT_DECLARE(type, Type, struct, (floating) (fixed) (unsigned_fixed) (integer) (unsigned_integer))
        META_ASPECT_DECLARE(compression, Compression, struct, (normal) (compressed))
        META_ASPECT_DECLARE(restriction, Restriction, struct, (unknown) (any) (texture) (renderbuffer))
